...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/ngx-line-chart>
...
4. Now switch back to the Html file of the page and provide the dataset array name in the [datasets] attribute. For example, [results] = dataSet.
...
2. In the TS editor of the page, enter the following code: Copy CodeJavaScriptlineChartData: Array<any> =[{{"name": "Germany","series": [{"value": 4168,"name":2010 },{"value": 4529,"name":2011 },{"value": 6575,"name":2012 },]},{"name": "USA","series": [{"value": 5481,"name":2010},{"value": 5881,"name":2011},{"value": 3860,"name":2012},]}];
