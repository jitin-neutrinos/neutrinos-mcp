...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/ng-polar-area-chart>

## Polar Area Chart

### Overview

The** Polar Area Chart** provides detailed comparison information. The radius of the sector differs according to the value in datasets whereas, in the **Pie Chart **the radius of each slice is the same. In this chart, the difference in data can be found easily by looking at the radius of the slice.
