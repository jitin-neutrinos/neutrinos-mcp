...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/create-an-advanced-component>

## Create an Advanced Component

### Overview

Advanced components are an extension of the **Component** class. It provides more features such as:
...
Every advanced component has a lifecycle. It is a sequence of events that an advanced component’s life experiences. These events are called** Lifecycle Hooks**. If necessary, you can use these lifecycle hooks to do something (run some code) whenever one of these events occur.
...
To create an advanced component in Neutrinos Studio, perform the following steps:
...
Before creating an advanced component, you should design the template of the component that you want to create. For example, before creating a Table component, design its template to accommodate configurable Sort, Paginator, and Filter sub-components within it.

Follow the [Advanced Component- Design guidelines](/articles/components-guide-for-release-6/create-an-advanced-component)to design the template.
...
| ![Information](/resources/Storage/components-guide-for-release-6/info.png) | The name of the component should be prefixed with the package name. For example: **const name = 'ng-card-action'**. |
| --- | --- |
...
```javascript
advancedComponentOptions = {  name: '',  template: '',  designerTemplate: '',  paletteTemplate: '',  componentLabel: '', // optional  templateUrl: '', // optional  isAdvancedChild: false, // optional. Declare the component as an advanced child  visible: true, // optional. Declare if the component should be visible in the palette list}
```

**Step 6**: Add attributes to the Advanced Component. Create a **super** constructor with addAttribute method which takes all the parameters described from the Attribute class. The parameters include:
...
- **type**: The type of attribute which determines how the key is replaced during template generation:
  ...
  - **(optional) dav[dynamic-attribute-value]**: If you want to dynamically generate value for the key, then, there are three events which take a function as a value:
...
```javascript
super.setType(AdvancedComponent.COMPONENT_TYPE_TITLES.NGX_CHARTS.val);
```

**Step 9**: Create a get method to accept the template of the advanced component.

**Step 10**: Save the file within the package.
...
- [Define the designerTemplate using slots](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4_148746544)
- [Style the elements inside the slot](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4__981283192)
- [Listen to the HTML events on your element](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4__386328029)
- [Attach children or siblings to the component](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4__1759985169)
- [Share objects between parent and child elements](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4__1727228971)
- [Disable element copy](/articles/components-guide-for-release-6/create-an-advanced-component/a/h4_1043266511)
