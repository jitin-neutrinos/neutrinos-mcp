...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/footer>
...
7. A block with title, a paragraph with some content in the footer at the bottom will be displayed.
