...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/tables>
...
- **Show Header:** It allows you to choose if you want to show the Table's header or not. Choose True or False.
