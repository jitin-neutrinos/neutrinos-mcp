...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/ngx-stacked-vertical-bar-chart>
...
1. Drag and drop a **Stacked Vertical Bar ****Chart** to the page container.
2. In the TS editor of the page, enter the following code: Copy CodeJavaScriptsverticalbarChartData: Array<any> = [
    {
    "name": "Germany",
