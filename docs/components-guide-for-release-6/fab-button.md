...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/fab-button>
...
3. When the page is loaded the value **fabicon = decorate** will be the name of the button that will be displayed on the button and **click = clickEvent()** is the event that runs when the button is pressed. On clicking the button, the alert message Button clicked!!! will be displayed and **disable ripple=false** will disable the ripple animation when the button is clicked.
