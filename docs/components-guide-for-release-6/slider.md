...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/slider>
...
- **Thumb-label**: Specifies whether or not to show the thumb label. The value should be a boolean i.e. either true or false. **Example:- **thumbLabel: boolean.
