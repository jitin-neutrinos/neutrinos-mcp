...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/grid-list>
...
3. In the above example, the **Grid List** has two columns, and **Grid Tile **is an array that has four items containing string values that are basically labels. The labels are displayed using *ngFor.
