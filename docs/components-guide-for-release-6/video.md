...
<https://documentation.neutrinos.com/articles/#!components-guide-for-release-6/video>

## Video

### Overview

A custom directive based on Cordova to record videos using the camera and upload the file. It can be used only on mobiles. If you want to use this diretctive, add the **n-video** custom directive to any component.
