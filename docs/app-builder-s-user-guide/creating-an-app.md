...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/creating-an-app>
...
- Use the** Plugins** option on the top menu to [download existing app plugins](/articles/app-builder-s-user-guide/import-plugin) to your workspace. Plugins downloaded on the workspace can be applied to any app.
...
![edit app window](/resources/Storage/app-builder-s-user-guide/edit_app_details.png)
