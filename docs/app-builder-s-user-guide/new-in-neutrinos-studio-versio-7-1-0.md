...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/new-in-neutrinos-studio-versio-7-1-0>
...
![The chip component](/resources/Storage/app-builder-s-user-guide/chip.png)
...
![Autocomplete component](/resources/Storage/app-builder-s-user-guide/autocomplete1.png)

[Paginator](/smart/project-components-documentation-copy/pagination): used to provide navigation for paged information.



 ![paginator](/resources/Storage/app-builder-s-user-guide/paginator.png)
...
A new [Login template](/smart/project-components-documentation-copy/neutrinos-login-templates) is added to Neutrinos Store.
 ...
 [Google](/articles/app-builder-s-user-guide/configure-ids-with-google)


 [Active Directory](/articles/app-builder-s-user-guide/configure-ids-with-active-directory)


 [Azure](/articles/app-builder-s-user-guide/configure-ids-with-azure)
 ...
 **Skip Team Check Option**
 ...
 ![Skip team check](/resources/Storage/app-builder-s-user-guide/Skiptc.png)
 ...
 **isLoggedIn Property**
 ...
 Post login or logout, if you want to redirect your web app users to specific pages, you can perform the steps documented in the [Redirecting web app users](/articles/app-builder-s-user-guide/use-ids/a/h3_1722131387) topic.
