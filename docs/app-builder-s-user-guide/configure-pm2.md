...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/configure-pm2>
...
| ![Information](/resources/Storage/app-builder-s-user-guide/info.png) | A server application should be compiled before you start PM2. |
| --- | --- |
