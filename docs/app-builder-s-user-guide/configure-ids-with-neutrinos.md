...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/configure-ids-with-neutrinos>
...
![Neutrinos IDS](/resources/Storage/app-builder-s-user-guide/neutrinos_ids.png)
...
- Create and manage **Teams** on Neutrinos Console to authorize users based on roles. See [Manage Teams](/articles/app-builder-s-user-guide/manage-teams).
