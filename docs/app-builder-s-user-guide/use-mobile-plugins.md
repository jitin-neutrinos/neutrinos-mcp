...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/use-mobile-plugins>
...
![platform cordova](/resources/Storage/app-builder-s-user-guide/platforms.png)
