...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/preview-the-ios-app>
...
| ![Information](/resources/Storage/app-builder-s-user-guide/info.png) | Make sure you initialize the app before performing **Initialize iOS**. Else the mobile initialization will fail. |
| --- | --- |
