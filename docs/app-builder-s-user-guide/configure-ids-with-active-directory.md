...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/configure-ids-with-active-directory>
...
![Active Directory IDS](/resources/Storage/app-builder-s-user-guide/Active%20Directoy_ids.png)
...
- Import and use the IDS module in your application. See [Using the IDS Module](/articles/app-builder-s-user-guide/use-ids).
- To give users access to the app, create **Teams** and onboard** U****sers **on Neutrinos Console. You should have the **organisation admins** privilege to perform this operation. See [User Management](/articles/app-builder-s-user-guide/perform-user-management).
