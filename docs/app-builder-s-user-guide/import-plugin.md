...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/import-plugin>
...
3. In the Manage Plugins window, select **Plugins **and install the plugin to your app by selecting the plugin and clicking **Add**.
    ![global plugins](/resources/Storage/app-builder-s-user-guide/global%20plugin.png)
4. The plugin will install and will get listed under **App Plugins**.
    ![app plugins](/resources/Storage/app-builder-s-user-guide/app%20plugin.png)
