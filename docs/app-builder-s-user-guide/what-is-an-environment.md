...
<https://documentation.neutrinos.com/articles/#!app-builder-s-user-guide/what-is-an-environment>

To manage environment-specific properties and values, access the **Environments** editor within your application.
...
![Environments editor](/resources/Storage/app-builder-s-user-guide/Envi7.png)
...
- Click ![the Clone icon](/resources/Storage/app-builder-s-user-guide/clone_icon.png) next to the environment that you want to clone.
