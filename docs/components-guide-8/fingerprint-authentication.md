...
<https://documentation.neutrinos.com/articles/#!components-guide-8/fingerprint-authentication>
...
| ![Information](/resources/Storage/components-guide-8/info.png) | Make sure the version 2.0.0 of the [cordova-plugin-fingerprint-aio](https://www.npmjs.com/package/cordova-plugin-fingerprint-aio) plugin is installed. |
| --- | --- |
...
| ![Information](/resources/Storage/components-guide-8/components-guide-for-release-6/info.png) | console.log($event) displays the output (which is $event) of the directive for both success and error on a console which can be accessed by google chrome or safari. |
| --- | --- |
