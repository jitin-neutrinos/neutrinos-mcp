...
<https://documentation.neutrinos.com/articles/#!components-guide-8/ngx-bubble-chart>
...
- Drag and drop the **Ngx ****Bubble Chart** from the Ngx Charts category.
...
2. Copy CodeJavaScriptpage.bubbleChartData: Array<any> =[{"name": "USA","series": [{"name": "2010","x": 197,"y": 75,"r": 310},{"name": "2000","x": 201,"y": 20,"r": 283},{"name": "1990","x": 270,"y": 30,"r": 253}]},{"name": "France","series": [{"name": "2010","x": 367,"y": 81.4,"r": 63},{"name": "2000","x": 347,"y": 79.1,"r": 59.4},{"name": "1990","x": 294,"y": 77.2,"r": 56.9}]}];
3. In the Page Variable node of the On Init flow, add the following variables:
4. **Page Variable**
   **Default Value**
   bubbleChartData
   Select **page**. and enter **bubbl****eChartData**
...
10. Drag and drop an **Ngx Bubble Chart** component and set the following properties:
  1. [result]: page.bubbleChartData
  2. showLegend: true
  3. [legendTitle]: 'countries'
  4. [legendPosition]: right
