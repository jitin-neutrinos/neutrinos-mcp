...
<https://documentation.neutrinos.com/articles/#!components-guide-8/tabs>
...
| ![Information](/resources/Storage/components-guide-8/info.png) | You cannot minimize the tab content within Tabs. Also, you cannot copy the tab content. |
| --- | --- |
