...
<https://documentation.neutrinos.com/articles/#!components-guide-8/mini-fab-button>
...
3. Drag and drop a **Snackbar node** and set the following properties:
  ...
  2. **Action Text**: Okay
4. Connect the nodes.
5. Navigate to the UI editor of the page, drag and drop the **Mini** **Fab** **Button **component to a page.
6. Double click the Mini Fab Button component and set the following properties:
  1. **fabicon**: Info
