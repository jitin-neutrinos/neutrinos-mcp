...
<https://documentation.neutrinos.com/articles/#!components-guide-8/text-to-speech>
...
| ![Information](/resources/Storage/components-guide-8/info.png) | Make sure the version 1.0.0 of the **[cordova-plugin-neutts](https://www.npmjs.com/package/cordova-plugin-neutts) **plugin is installed. |
| --- | --- |
