...
<https://documentation.neutrinos.com/articles/#!components-guide-8/progress-bar>
...
1. On the UI editor of the page, drag and drop the **Progress Spinner **component. Set the properties:
  1. **Mode**: Buffer
  2. **Color**: warn
  3. **bufferValue**: 30
2. Save run the page.
