...
<https://documentation.neutrinos.com/articles/#!components-guide-8/slider>
...
1. On the UI editor of the page, drag and drop the **Slider** component. Set the following properties:
  1. **color: **warn
  2. **max: **100000
  3. **min: **0
  4. **step: **1000
