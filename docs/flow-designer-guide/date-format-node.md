...
<https://documentation.neutrinos.com/articles/#!flow-designer-guide/date-format-node>
...
- **Action: **The action to be performed on the parameters. See [Format Actions](/articles/flow-designer-guide/date-format-node/a/h3_941599958) to learn about the actions that can be performed using this node.
