# this.page.system.loginService

<https://documentation.neutrinos.com/articles/#!flow-designer-guide/this-page-system-loginservice>
...
bh.system.loginService provides methods and variables for a user to log in to an application.
 ...
 Login service is disabled starting from Studio version 8.

**Methods:**



 [login()](/smart/project-service-designer-user-s-guide/system-loginservice/a/login)[isLoggedIn()](/smart/project-service-designer-user-s-guide/system-loginservice/a/isLoggedIn) **Variables:**
 ...
 systemService: [system.deviceService](/smart/project-service-designer-user-s-guide/system-deviceservice)
 nSessionStorage: [NSessionStorageService](/smart/project-service-designer-user-s-guide/system-sessionstorageservice)
