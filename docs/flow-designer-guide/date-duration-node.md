...
<https://documentation.neutrinos.com/articles/#!flow-designer-guide/date-duration-node>
...
- **Action: **The action to be performed on the parameters. See [Duration Actions](/articles/flow-designer-guide/date-duration-node/a/h3_825119271) to learn about the actions that can be performed using this node.
- **Result Mapping: **Returns the output based on the action you choose. You can map the result to a[flow or page variable](/articles/flow-designer-guide/properties-page-designer).
