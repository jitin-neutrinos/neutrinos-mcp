...
<https://documentation.neutrinos.com/articles/#!console-quick-links/meet-your-requirements>

Before you start creating your app on Neutrinos Studio, make sure you meet the following requirements:
...
See [Setup Proxy on Neutrinos Studio](/smart/project-sample-how-to-guide/setup-proxy-on-neutrinos-studio) to learn more.
...
| ![Information](/resources/Storage/console-quick-links/info.png) | If you want to learn about the prerequisites to install previous versions of Neutrinos Studio, navigate to the **App Builder Guide** in our [Docs Archive](http://docs1.neutrinos.co/articles/doc-archive-publication). |
| --- | --- |
