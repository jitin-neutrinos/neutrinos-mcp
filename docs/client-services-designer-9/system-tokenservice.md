...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/system-tokenservice>

bh.system.tokenService provides methods for authentication token management on the application frontend.

**Methods:**[updateTokens()](/articles/client-services-designer-9/system-tokenservice/a/updateTokens)[isTokenExpired()](/articles/client-services-designer-9/system-tokenservice/a/isTokenExpired)[decodeToken()](/articles/client-services-designer-9/system-tokenservice/a/decodeToken)[updateSessionStorage()](/articles/client-services-designer-9/system-tokenservice/a/updateSessionStorage)**Variable:**SessionStorage:This variable stores data on a temporary basis, for a single-window (or tab). The data disappears when the session ends i.e. when the user closes that window (or tab). **Syntax:**Copy CodeJavaScripttokenservice.SessionStorage → any;
