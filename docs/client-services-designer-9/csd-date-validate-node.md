...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/csd-date-validate-node>
...
- **Action**: The action to be performed on the parameters. See [Validate Actions](/articles/client-services-designer-9/csd-date-validate-node/a/h3__1475266389) to learn about the actions that can be performed using this node.
- **Result Mapping**: Returns **True** or **False**. Enter the [flow variable](/articles/client-services-designer-9/service-designer-variables) to which you want to map the result.
