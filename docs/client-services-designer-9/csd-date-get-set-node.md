...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/csd-date-get-set-node>
...
- **Action**: The action to be performed on the parameters. See [Get Set Actions](/articles/client-services-designer-9/csd-date-get-set-node/a/h3__1710887367) to learn about the actions that can be performed using this node.
