...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/get-node>

The** Get** node is used to fetch specific records from an object store in the [IndexedDB](/articles/client-services-designer-9/indexeddb-nodes) database.
...
3. **Store Name:** The object store on which you want to perform transactions. Enter the [flow object](/articles/client-services-designer-9/service-designer-variables)containing the object store name.
...
9. **Result Mapping:** The result of the operation. Enter the [flow object](/articles/client-services-designer-9/service-designer-variables)in which you want to save the result.
