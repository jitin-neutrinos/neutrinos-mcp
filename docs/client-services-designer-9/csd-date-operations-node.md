...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/csd-date-operations-node>
...
- **Action: **The action to be performed on the parameters. See [Date Actions](/articles/client-services-designer-9/csd-date-operations-node/a/Date Actions) to learn about the actions that can be performed using this node.
- **Result Mapping: **Returns a moment object. Enter the [flow variable](/articles/client-services-designer-9/service-designer-variables) to which you want to map the result.
