...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/system-loginservice>
...
**Methods:**
 ...
 [login()](/articles/client-services-designer-9/system-loginservice/a/login)[isLoggedIn()](/articles/client-services-designer-9/system-loginservice/a/isLoggedIn) **Variables:**
 loginUrl: Neutrinos Art authentication URL if the application is migrated from previous versions of Studio which used Neutrinos Art.
  ...
  systemService: [system.deviceService](/articles/client-services-designer-9/system-deviceservice)
  nSessionStorage: [NSessionStorageService](/articles/client-services-designer-9/system-sessionstorageservice)
