...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/open-dialog-node>
...
| ![Information](/resources/Storage/client-services-designer-9/info.png) | You can provide more than one class in this field. Note that Has Backdrop should be set to True for this class to take effect. |
| --- | --- |
...
![](/resources/Storage/client-services-designer-9/flow-designer-guide/open_dialog.png)
