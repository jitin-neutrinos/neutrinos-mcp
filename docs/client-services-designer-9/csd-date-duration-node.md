...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/csd-date-duration-node>
...
- **Action: **The action to be performed on the parameters. See [Duration Actions](/articles/client-services-designer-9/csd-date-duration-node/a/h3_825119271) to learn about the actions that can be performed using this node.
- **Result Mapping: **Returns the output based on the action you choose. Enter the [flow variable](/articles/client-services-designer-9/service-designer-variables) to which you want to map the result.
