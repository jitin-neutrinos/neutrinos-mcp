...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/system-pubsubservice>
...
**Methods:**
 ...
 [$pub(event: string, eventObject?: any);](/articles/client-services-designer-9/system-pubsubservice/a/pub)
 [$sub(event: string, callback?: (value: any) => void, error?: (error: any) => void, complete?: () => void): Subscription;](/articles/client-services-designer-9/system-pubsubservice/a/sub)
