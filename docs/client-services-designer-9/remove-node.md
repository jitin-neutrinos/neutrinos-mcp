...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/remove-node>

The** Remove** node is used to delete a record or records from the object store in the [IndexDB database](/articles/client-services-designer-9/indexeddb-nodes).
...
5. **Transaction Object: **Optional. The result mapping variable of the [Transaction](/articles/client-services-designer-9/transaction-node) node.
