...
<https://documentation.neutrinos.com/articles/#!client-services-designer-9/csd-date-format-node>
...
- **Action: **The action to be performed on the parameters. See [Format Actions](/articles/client-services-designer-9/csd-date-format-node/a/h3_941599958) to learn about the actions that can be performed using this node.
