...
<https://documentation.neutrinos.com/articles/#!components-guide-7/list-item>

## List Item

### Overview

The** List Item** component contains individual data of items that will be placed inside the **List** component. The data can be stored in an array or object and it will be accessed from the array by the ngFor attribute.
...
- **Label:** This attribute displays the name as list items. Provide the extension as (.name). This will access the folder's object and get the name value. If the folder's object contains three values such as photos, work, and document, then the list items will be photos, work, and document.
