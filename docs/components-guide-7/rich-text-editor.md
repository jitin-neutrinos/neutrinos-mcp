...
<https://documentation.neutrinos.com/articles/#!components-guide-7/rich-text-editor>
...
| ![Information](/resources/Storage/components-guide-7/info.png) | Make sure you have Neutrinos Studio version 7.2.2 and above to use this component |
| --- | --- |
...
- **Manual Configuration**: If set to TRUE, the attributes window allows you to manually configure the options to be displayed on top of the editor. The options that you can show/hide include: ![](/resources/Storage/components-guide-7/components-guide-7/1-1-7-1-rich-text-editor-img0001.png)
