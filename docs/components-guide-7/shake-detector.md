...
<https://documentation.neutrinos.com/articles/#!components-guide-7/shake-detector>
...
| ![Information](/resources/Storage/components-guide-7/info.png) | Make sure the version 1.0.0 of the **[cordova-plugin-neushake](https://www.npmjs.com/package/cordova-plugin-neushake) **plugin is installed. |
| --- | --- |
