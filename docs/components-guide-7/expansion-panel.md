...
<https://documentation.neutrinos.com/articles/#!components-guide-7/expansion-panel>

## Expansion Panel

### Overview

** expansion Panel** is a container that contains components such as **Expansion header**, **Expansion title**,** Expansion description**, etc. **Expansion panel** can be used alone with all these components or it can be put inside an **Expansion panel outlet **component.
