...
<https://documentation.neutrinos.com/articles/#!components-guide-7/grid-tile>
...
4. In the above example, the grid has two columns, and tile is an array that has four items that contain string values that basically label. So, using **ngFor** the labels will be displayed.
