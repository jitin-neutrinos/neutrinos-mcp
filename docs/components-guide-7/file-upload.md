...
<https://documentation.neutrinos.com/articles/#!components-guide-7/file-upload>

## File Upload

| ![Warning](/resources/Storage/components-guide-7/warning.png) | This component is not supported from Neutrinos Studio version 7.2.1. |
| --- | --- |
