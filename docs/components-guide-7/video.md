...
<https://documentation.neutrinos.com/articles/#!components-guide-7/video>
...
| ![Information](/resources/Storage/components-guide-7/info.png) | Make sure the version 3.0.2 of the **[cordova-plugin-media-capture](https://www.npmjs.com/package/cordova-plugin-media-capture) **plugin is installed. |
| --- | --- |
