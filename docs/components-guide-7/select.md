...
<https://documentation.neutrinos.com/articles/#!components-guide-7/select>
...
| ![Information](/resources/Storage/components-guide-7/info.png) | If Group Options is enabled, the following attributes should be set as follows:optionValue: subOption.valueoptionView: {{subOption.viewValue}} |
| --- | --- |
