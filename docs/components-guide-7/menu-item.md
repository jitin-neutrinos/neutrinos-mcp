...
<https://documentation.neutrinos.com/articles/#!components-guide-7/menu-item>
...
- **Menu Item Label: **The label given for the Menu Item. Example: If you give the label as ABC, then the value ABC is displayed next to the Menu Item.
...
- **MenuItemName:** It is the name of the menu item that appears in the application. Takes a string as its value. Example- **item1**.
- **(click):** Event occurred when the menu item is clicked.
- **Disabled (True/False):** Used to check whether the button is disabled or not.
