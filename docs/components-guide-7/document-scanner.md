...
<https://documentation.neutrinos.com/articles/#!components-guide-7/document-scanner>
...
| ![Information](/resources/Storage/components-guide-7/info.png) | Make sure the version 2.0.1 of the [cordova-plugin-document-scanner](https://www.npmjs.com/package/cordova-plugin-document-scanner) plugin is installed. |
| --- | --- |
