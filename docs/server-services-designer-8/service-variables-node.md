...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/service-variables-node>
...
- **Variables list**: Displays the list of variables added for the particular operation type.See [Properties](/articles/server-services-designer-8/properties-in-server-services) to learn more.
