...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/tele-call-node>
...
3. **Nexmo Config: ** The name of the configuration that connects to the Nexmo APIs.
  ...
  - If you want to create a new Nexmo configuration, select **Add new config** from the drop-down list and click the **Map** icon to add a new configuration. See [Attributes for a new Nexmo Config](/articles/server-services-designer-8/communication/a/newnexmoconfig) to learn about the properties to configure.
