...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/date-validate>
...
- **Action:** The action to be performed on the parameters. See [Validate Actions](/articles/server-services-designer-8/date-validate/a/h3__1475266389) to learn about the actions that can be performed using this node.
