...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/date-operations>
...
- **Action:** The action to be performed on the parameters. See [Date Actions](/articles/server-services-designer-8/date-operations/a/h3__1710887367) to learn about the actions that can be performed using this node.
