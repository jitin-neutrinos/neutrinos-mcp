...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/yml-node>
...
1. **Name**: The name for the node. This name will display on the canvas when you save the node.![YML node attributes](/resources/Storage/server-services-designer-8/YMl.png)
