...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/proposal-v2-node>
...
- **Policy: **An object containing the policy information. Create an object in the [Script](/articles/server-services-designer-8/script-node) node and pass the object name in this field. The object should contain the following information:Copy CodeJavaScript"policy": {
    "customers": [],
