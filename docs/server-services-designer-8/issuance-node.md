...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/issuance-node>
...
- **Collection:** An object containing the payment information. Create an object in the [Script](/articles/server-services-designer-8/script-node) node and pass the object name in this field. The object should contain the following information: Copy CodeJavaScript"collection":
   {
