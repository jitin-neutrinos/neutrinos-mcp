...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/catch-node>
...
| ![Information](/resources/Storage/server-services-designer-8/info.png) | In a server flow, if the Catch node is not enabled for a node, its exception will be passed to its previous node in the flow. |
| --- | --- |
...
![Catch with HTTP Out node](/resources/Storage/server-services-designer-8/catch_http.png)
