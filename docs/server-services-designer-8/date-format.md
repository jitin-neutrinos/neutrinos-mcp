...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/date-format>
...
- **Action:** The action to be performed on the parameters. See [Format Actions](/articles/server-services-designer-8/date-format/a/h3_941599958) to learn about the actions that can be performed using this node.
