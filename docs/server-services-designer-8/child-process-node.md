...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/child-process-node>
...
| ![Information](/resources/Storage/server-services-designer-8/info.png) | You can have multiple child processes in a service flow. |
| --- | --- |
...
- **Command: **The command that you want to execute.
  - To map the command to a variable, choose bh. , bh.input or bh.local property from the drop-down list and enter the variable name which contains the command. ![Child process command](/resources/Storage/server-services-designer-8/cp_bh.png)
  - To enter the command, choose string and enter the command directly.![Child process command](/resources/Storage/server-services-designer-8/cp_exec.png)
...
![Child Process example1](/resources/Storage/server-services-designer-8/exec.png)

**HTTP In node:**

![The HTTP IN node](/resources/Storage/server-services-designer-8/exec1.png)

**Script node:**

![Script node](/resources/Storage/server-services-designer-8/exec2.png)

**Child process node in Exec mode:**

![Child Process node](/resources/Storage/server-services-designer-8/exec3.png)

**HTTP Out node:**

![HTTP Out node](/resources/Storage/server-services-designer-8/exec4.png)
...
![Spawn mode](/resources/Storage/server-services-designer-8/spawn.png)

**HTTP In node:**

![HTTP In node](/resources/Storage/server-services-designer-8/spawn1.png)

**Script node:**

![Script node](/resources/Storage/server-services-designer-8/spawn2.png)

**Child Process Node in Spawn Mode:**

![child process- spawn node](/resources/Storage/server-services-designer-8/spawn3.png)
...
![](/resources/Storage/server-services-designer-8/spawn4.png)

![File out node](/resources/Storage/server-services-designer-8/spawn7.png)
...
![script node](/resources/Storage/server-services-designer-8/spawn5.png)

![File out node](/resources/Storage/server-services-designer-8/spawn8.png)
...
![script node](/resources/Storage/server-services-designer-8/spawn6.png)
