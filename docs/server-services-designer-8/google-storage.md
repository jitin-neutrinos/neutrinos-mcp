...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/google-storage>
...
- [Google Storage Object node](/articles/server-services-designer-8/google-storage-object-node)
- [Google Storage Bucket node](/articles/server-services-designer-8/google-storage-bucket-node)

| ![](/resources/Storage/server-services-designer-8/info.png) | This node is available from Neutrinos Studio Release 7.4.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs. |
| --- | --- |
