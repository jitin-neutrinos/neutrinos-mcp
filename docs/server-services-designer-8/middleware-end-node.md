...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/middleware-end-node>
...
- **Response Types**: A drop-down list displaying the types of data the HTTP response returns. If you want to map this field to a bh.input, or bh.local variable, click the **Map button**, select the property, and input the variable name. See [properties](/articles/server-services-designer-8/properties-in-server-services) to learn more.
