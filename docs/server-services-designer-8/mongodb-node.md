...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/mongodb-node>

The** MongoDB **node is used to connect to and perform operations on the MongoDB database.

| ![Information](/resources/Storage/server-services-designer-8/info.png) | This node is enhanced in Neutrinos Studio release 7.1.0. Therefore, you will see more attributes if you are using Studio versions later than 7.0.2. |
| --- | --- |
...
- **Name: **Enter a name for the node. This name will display on the canvas when you save the node. ![MongoDB node](/resources/Storage/server-services-designer-8/mongo_node.png)
- **Database Config: **The name of the database connection. If you have a database connection that you have already configured in the [Global Session](/articles/server-services-designer-8/global-session-node) node, choose that connection from the drop-down list. If you want to configure a new database, click the **Map** icon.
  ...
  - Click ![](/resources/Storage/server-services-designer-8/correct.png) to save the MongoDB connection.
...
![Find operation in MongoDB](/resources/Storage/server-services-designer-8/mongo_find.png)
...
![The findOneAndUpdate operation](/resources/Storage/server-services-designer-8/mongo_find_one_update.png)
...
![Count documents](/resources/Storage/server-services-designer-8/mongo_count_docs.png)
...
![Create index in mongoDB](/resources/Storage/server-services-designer-8/mongo_create_index.png)
...
![](/resources/Storage/server-services-designer-8/mongo_drop_index.png)
...
![Update One operation](/resources/Storage/server-services-designer-8/mongo_update_one.png)
...
![](/resources/Storage/server-services-designer-8/mongo_update_many.png)
...
![insert one operation](/resources/Storage/server-services-designer-8/mongo_insert_one.png)
...
![Delete one operation](/resources/Storage/server-services-designer-8/mongo_delete_one.png)

![Delete many operation](/resources/Storage/server-services-designer-8/mongo_delete_many.png)

aggregate

- **Pipeline: **Specify the array containing all the aggregation framework commands for the execution.

![Aggregate operation](/resources/Storage/server-services-designer-8/mongo_aggregate.png)
...
![the upload file operation](/resources/Storage/server-services-designer-8/mongodb-node-2020-02-24.png)

downloadFile

- **Filter**: Specify the filter used to select the document to remove. Select bh. or bh.local properties and enter the variable which contains the filter, or select** as is** from the drop-down list and enter the filter.

![the download file operation](/resources/Storage/server-services-designer-8/mongodb-node-2020-02-24-2.png)

deleteFile

- **Document Id**: Specify the unique id of the document that you need to delete.

![the delete operation](/resources/Storage/server-services-designer-8/mongodb-node-2020-02-24-4.png)

watch

- **pipeline**: Specify the array containing all the aggregation framework commands for the execution.

![the watch operation](/resources/Storage/server-services-designer-8/mongodb-node-2020-02-24-3.png)
