...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/ids-sequence>
...
![IDS Login Flow](/resources/Storage/server-services-designer-8/ids_login_api.png)
...
![logout API flow](/resources/Storage/server-services-designer-8/logout_api_flow1.png)
...
![logout callback api flow](/resources/Storage/server-services-designer-8/logout_callbacl_api_flow.png)
...
![Middleware flow to add HREF to bh](/resources/Storage/server-services-designer-8/href%20to%20bh%20flow.png)
...
![Redirect to login flow](/resources/Storage/server-services-designer-8/redirect_to_login.png)
...
![API to fetch user information](/resources/Storage/server-services-designer-8/api_fetch_userinfo.png)
...
![Midleware flow to check authorized API](/resources/Storage/server-services-designer-8/authorized_api_flow.png)
