...
<https://documentation.neutrinos.com/articles/#!server-services-designer-8/topic-node>
...
- **Select Operation:** Select the operation to be performed. See [Operations on a Topic](/articles/server-services-designer-8/topic-node/a/h3_1818896831). Based on the operation you choose, the attributes list will differ.
