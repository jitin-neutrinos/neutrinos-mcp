...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/manage-app-dependencies>
...
You can add custom dependencies of type npm and Angular to your application using the Plugin Manager on the Studio Application page. A custom dependency is added to serve a dedicated purpose in the application.
...
![](/resources/Storage/studio-guide-9/1-4-import-from-neutrinos-store-img0006.png)
