...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/preview-the-ios-app>
...
| ![Information](/resources/Storage/studio-guide-9/info.png) | Make sure you initialize the app before performing **Initialize iOS**. Else the mobile initialization will fail. |
| --- | --- |
