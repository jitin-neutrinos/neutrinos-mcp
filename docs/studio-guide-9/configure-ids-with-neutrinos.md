...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/configure-ids-with-neutrinos>
...
![Neutrinos IDS](/resources/Storage/studio-guide-9/neutrinos_ids.png)
...
- Create and manage **Teams** on Neutrinos Console to authorize users based on roles. See [Manage Teams](/articles/studio-guide-9/manage-teams).
