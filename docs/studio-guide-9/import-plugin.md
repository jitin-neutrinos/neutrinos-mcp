...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/import-plugin>
...
3. In the Manage Plugins window, select **Plugins **and install the plugin to your app by selecting the plugin and clicking **Add**.
    ![global plugins](/resources/Storage/studio-guide-9/global%20plugin.png)
4. The plugin will install and will get listed under **App Plugins**.
    ![app plugins](/resources/Storage/studio-guide-9/app%20plugin.png)
