...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/use-ids>
...
4. On the Page UI, [bind the page flow to a component's attribute](/articles/studio-guide-9/bind-page-flows-to-components). For example, drag and drop a **Button** and bind the** logout** flow to the (click) attribute of the button.
