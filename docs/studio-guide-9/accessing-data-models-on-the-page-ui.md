...
<https://documentation.neutrinos.com/articles/#!studio-guide-9/accessing-data-models-on-the-page-ui>

When you create a page on Neutrinos Studio, along with the page variable, a namespace called page.dm gets created. This namespace can be used to access the data model that you have designed on the **[Models](/articles/studio-guide-9/designing-data-models)** editor, and bind them to the page UI. See [Properties in Page Designer](/smart/project-page-services-designer-guide/properties-page-designer) to learn about the page properties in more detail.
...
2. Create a new data model called **user**.
    ![the user data model](/resources/Storage/studio-guide-9/user_datamodel.png)
3. Create the following data model attributes:
    ![attributes of the data model](/resources/Storage/studio-guide-9/user_dm_attr.png)
4. Save the changes.
 ...
 **Step 4: Bind the Page Flow to a Component's Attribute:**
 ...
 ![preview of the app](/resources/Storage/studio-guide-9/user_details.png)
