...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/google-storage>
...
- [Google Storage Object node](/articles/server-side-service-designer-publication/google-storage-object-node)
- [Google Storage Bucket node](/articles/server-side-service-designer-publication/google-storage-bucket-node)

| ![](/resources/Storage/server-side-service-designer-publication/info.png) | This node is available from Neutrinos Studio Release 7.4.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs. |
| --- | --- |
