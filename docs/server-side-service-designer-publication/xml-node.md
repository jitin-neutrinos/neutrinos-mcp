...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/xml-node>
...
1. **Name**: The name for the node. This name will display on the canvas when you save the node. ![The sttributes of xml node](/resources/Storage/server-side-service-designer-publication/xml.png)
