...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/ids-sequence>
...
![IDS Login Flow](/resources/Storage/server-side-service-designer-publication/ids_login_api.png)
...
![logout API flow](/resources/Storage/server-side-service-designer-publication/logout_api_flow1.png)
...
![logout callback api flow](/resources/Storage/server-side-service-designer-publication/logout_callbacl_api_flow.png)
...
![Middleware flow to add HREF to bh](/resources/Storage/server-side-service-designer-publication/href%20to%20bh%20flow.png)
...
![Redirect to login flow](/resources/Storage/server-side-service-designer-publication/redirect_to_login.png)
...
![API to fetch user information](/resources/Storage/server-side-service-designer-publication/api_fetch_userinfo.png)
...
![Midleware flow to check authorized API](/resources/Storage/server-side-service-designer-publication/authorized_api_flow.png)
