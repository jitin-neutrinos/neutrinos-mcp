...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/catch-node>
...
| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | In a server flow, if the Catch node is not enabled for a node, its exception will be passed to its previous node in the flow. |
| --- | --- |
...
![Catch with HTTP Out node](/resources/Storage/server-side-service-designer-publication/catch_http.png)
