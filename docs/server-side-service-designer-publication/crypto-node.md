...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/crypto-node>
...
- **Type of Operation: **The type of operation you want to perform on the data. See [Crypto Operations](/articles/server-side-service-designer-publication/crypto-node/a/h3__1822811531) to learn more.
