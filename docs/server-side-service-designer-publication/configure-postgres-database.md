...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/configure-postgres-database>
...
- **Database Config: **The name of the database connection. ![exist vs new](/resources/Storage/server-side-service-designer-publication/existvsnew.png)
...
- **Query Mapping:** Enter a query, or map the query that is to be executed. ![postgres 1](/resources/Storage/server-side-service-designer-publication/postgres1.png)
...
- **Connection Name: **Specify the name of your connection. This name will appear in the drop-down list of database configs.![Postgres configuration](/resources/Storage/server-side-service-designer-publication/postgresconfig.png)
