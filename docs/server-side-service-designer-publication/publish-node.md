...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/publish-node>
...
| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | See [Amazon documentation](https://docs.aws.amazon.com/sns/latest/api/API_Publish.html) to learn about message attributes. |
| --- | --- |
