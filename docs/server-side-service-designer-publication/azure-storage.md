...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/azure-storage>

The Azure Storage platform is Microsoft's cloud storage solution for modern data storage scenarios. Core storage services offer a massively scalable object store for data objects, disk storage for Azure virtual machines (VMs), a file system service for the cloud, a messaging store for reliable messaging, and a NoSQL store.

Azure Storage includes 2 nodes:

- [Azure Storage Container node](/articles/server-side-service-designer-publication/azure-storage-container-node)
- [Azure Storage Blob node](/articles/server-side-service-designer-publication/azure-storage-blob-node)
