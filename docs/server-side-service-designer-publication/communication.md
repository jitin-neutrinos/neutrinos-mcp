...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/communication>
...
- [Tele Call node](/articles/server-side-service-designer-publication/tele-call-node)
- [Get Call Recording](/articles/server-side-service-designer-publication/get-call-recording-node)
- [Get Instance](/articles/server-side-service-designer-publication/get-instance-node)

| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | This node package internally uses the Nexmo npm package. See the [Nexmo documentation](https://www.npmjs.com/package/nexmo) to learn more. |
| --- | --- |
...
| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | To get the API Key, API Secret, and the Application ID, you should create a developer account on Nexmo (Vonage). See [https://dashboard.nexmo.com/sign-up](https://dashboard.nexmo.com/sign-up) . |
| --- | --- |
