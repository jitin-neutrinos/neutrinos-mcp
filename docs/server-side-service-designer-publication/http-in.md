...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/http-in>
...
- **Destination**: Defines where the file should be saved after uploading. Choose **File Path** or **Memory**. The drop-down options change based on your selection:![File upload in http](/resources/Storage/server-side-service-designer-publication/file_upload.png)
...
- **Summary: **The summary of the API endpoint.![Documentation of http in](/resources/Storage/server-side-service-designer-publication/Httpin_doc.png)
...
![Swagger documentation link](/resources/Storage/server-side-service-designer-publication/swagger1.png)

A sample swagger doc looks like:

![The generated swagger document](/resources/Storage/server-side-service-designer-publication/swaggerdoc.jpeg)
