...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/service-variables-node>
...
- **Operations: **The type of operation the node should perform.
- **Variables list**: Displays the list of variables added for the particular operation type.See [Properties](/articles/server-side-service-designer-publication/properties-in-server-services) to learn more.
