...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/date-get-set>
...
- **Action:** The action to be performed on the parameters. See [Get Set Actions](/articles/server-side-service-designer-publication/date-get-set/a/h3__1710304451) to learn about the actions that can be performed using this node.
