...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/yml-node>
...
1. **Name**: The name for the node. This name will display on the canvas when you save the node.![YML node attributes](/resources/Storage/server-side-service-designer-publication/YMl.png)
