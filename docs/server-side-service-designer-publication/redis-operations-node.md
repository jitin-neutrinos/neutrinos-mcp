...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/redis-operations-node>
...
- **Redis Config: **The name of the database connection. If you have a database connection that you have already configured in the [Global Session](/articles/server-side-service-designer-publication/global-session-node) node, choose that connection from the drop-down list. If you want to configure a new database, click the **Map** icon. See [Attributes for a new configuration](/articles/server-side-service-designer-publication/redis/a/h3_964573856) to learn about the database parameters.
