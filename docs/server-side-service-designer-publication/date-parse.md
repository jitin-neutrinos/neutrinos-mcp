...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/date-parse>
...
- **Action:** The action to be performed on the parameters. See [Parse actions](/articles/server-side-service-designer-publication/date-parse/a/h3__929851382) to learn about the actions that can be performed using this node.
