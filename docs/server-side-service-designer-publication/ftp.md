...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/ftp>
...
- [SFTP List](/articles/server-side-service-designer-publication/sftp-list)
- [SFTP Get](/articles/server-side-service-designer-publication/sftp-get)
- [SFTP Put](/articles/server-side-service-designer-publication/sftp-put)
- [SFTP Command](/articles/server-side-service-designer-publication/sftp-command)

| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | This node is available from Neutrinos Studio Release 7.4.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs. |
| --- | --- |
...
- **Name**: A name for the textract config.
- **Client ****Name (String)**: Enter the client name for the SFTP config.
