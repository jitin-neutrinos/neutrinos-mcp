...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/child-process-node>
...
| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | You can have multiple child processes in a service flow. |
| --- | --- |
...
- **Command: **The command that you want to execute.
  - To map the command to a variable, choose bh. , bh.input or bh.local property from the drop-down list and enter the variable name which contains the command. ![Child process command](/resources/Storage/server-side-service-designer-publication/cp_bh.png)
  - To enter the command, choose string and enter the command directly.![Child process command](/resources/Storage/server-side-service-designer-publication/cp_exec.png)
...
![Child Process example1](/resources/Storage/server-side-service-designer-publication/exec.png)

**HTTP In node:**

![The HTTP IN node](/resources/Storage/server-side-service-designer-publication/exec1.png)

**Script node:**

![Script node](/resources/Storage/server-side-service-designer-publication/exec2.png)

**Child process node in Exec mode:**

![Child Process node](/resources/Storage/server-side-service-designer-publication/exec3.png)

**HTTP Out node:**

![HTTP Out node](/resources/Storage/server-side-service-designer-publication/exec4.png)
...
![Spawn mode](/resources/Storage/server-side-service-designer-publication/spawn.png)

**HTTP In node:**

![HTTP In node](/resources/Storage/server-side-service-designer-publication/spawn1.png)

**Script node:**

![Script node](/resources/Storage/server-side-service-designer-publication/spawn2.png)

**Child Process Node in Spawn Mode:**

![child process- spawn node](/resources/Storage/server-side-service-designer-publication/spawn3.png)
...
![](/resources/Storage/server-side-service-designer-publication/spawn4.png)

![File out node](/resources/Storage/server-side-service-designer-publication/spawn7.png)
...
![script node](/resources/Storage/server-side-service-designer-publication/spawn5.png)

![File out node](/resources/Storage/server-side-service-designer-publication/spawn8.png)
...
![script node](/resources/Storage/server-side-service-designer-publication/spawn6.png)
