...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/log-node>
...
- **Name:** A unique name for the node. This name will display on the canvas when you save the node. ![Log node properties](/resources/Storage/server-side-service-designer-publication/lognode.png)
