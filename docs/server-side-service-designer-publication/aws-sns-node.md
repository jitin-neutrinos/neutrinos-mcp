...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/aws-sns-node>
...
- [Topic](/articles/server-side-service-designer-publication/topic-node)
- [Publish](/articles/server-side-service-designer-publication/publish-node)
- [Subscription](/articles/server-side-service-designer-publication/subscription-node)
- [Get Message](/articles/server-side-service-designer-publication/get-message-node)

| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | This node is available from Neutrinos Studio Release 7.5.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs. |
| --- | --- |
