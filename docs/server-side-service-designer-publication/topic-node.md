...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/topic-node>
...
- **Select Operation:** Select the operation to be performed. See [Operations on a Topic](/articles/server-side-service-designer-publication/topic-node/a/h3_1818896831). Based on the operation you choose, the attributes list will differ.
