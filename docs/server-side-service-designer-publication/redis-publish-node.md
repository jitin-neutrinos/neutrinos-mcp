...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/redis-publish-node>
...
| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | You cannot subscribe to a channel to which you publish messages. |
| --- | --- |
