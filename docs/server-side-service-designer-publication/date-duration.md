...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/date-duration>
...
- **Action:** The action to be performed on the parameters. See [Duration Actions](/articles/server-side-service-designer-publication/date-duration/a/h3_825119271) to learn about the actions that can be performed using this node.
