...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/json-node>
...
1. **Name:** The name for the node. This name will display on the canvas when the node is saved. ![Json node](/resources/Storage/server-side-service-designer-publication/json_node.png)
