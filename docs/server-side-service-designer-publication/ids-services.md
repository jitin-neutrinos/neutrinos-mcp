...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/ids-services>
...
![IDS services](/resources/Storage/server-side-service-designer-publication/ids_services.png)
