...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/quotation-node>
...
- **Policy: **An object containing the policy information of the customer. Create an object in the [Script](/articles/server-side-service-designer-publication/script-node) node and pass the object name in this field. The object should contain the following information:Copy CodeJavaScript"policy": {
    "customers": [],
