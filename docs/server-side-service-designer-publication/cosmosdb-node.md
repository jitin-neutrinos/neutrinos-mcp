...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/cosmosdb-node>
...
- [Item node](/articles/server-side-service-designer-publication/item-node)
- [Container node](/articles/server-side-service-designer-publication/container-node)

| ![Information](/resources/Storage/server-side-service-designer-publication/info.png) | This node is available from Neutrinos Studio Release 7.7.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs or services in the Server Services Designer. |
| --- | --- |
