...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/container-node>
...
3. **Select CosmosDB Config:** The name of the config.
  ...
  - If you want to create a new CosmosDB configuration, select **Add new config** from the drop-down list and click the **Map** icon to configure a new config. See [Attributes for a new CosmosDB Config](/articles/server-side-service-designer-publication/cosmosdb-node/a/newcosmosdbconfig) to know what are the properties to configure.
