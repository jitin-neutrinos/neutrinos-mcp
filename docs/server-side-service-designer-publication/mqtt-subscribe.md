...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/mqtt-subscribe>
...
- **MQTT Config: **The name of the config.
  ...
  - If you want to configure a new MQTT broker, select **Add new config** from the drop-down list and click the **Map** icon to create a new configuration. See [Attributes for MQTT Configuration](/articles/server-side-service-designer-publication/mqtt/a/h3_1457337614) to learn the properties to configure.
