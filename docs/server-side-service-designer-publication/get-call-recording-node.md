...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/get-call-recording-node>
...
3. **Nexmo Config: ** The name of the configuration that connects to the Nexmo Service APIs.
  ...
  - If you want to create a new Nexmo configuration, select **Add new config** from the drop-down list and click the **Map** icon to add a new Nexmo configuration. See [Attributes for a new Nexmo Config](/articles/server-side-service-designer-publication/communication/a/newnexmoconfig) to know what are the properties to configure.
