...
<https://documentation.neutrinos.com/articles/#!server-side-service-designer-publication/call-service-node>
...
![Start node with flow object](/resources/Storage/server-side-service-designer-publication/cs_3.png)![call service using flow object](/resources/Storage/server-side-service-designer-publication/cs_4.png)
...
![Start node with input property](/resources/Storage/server-side-service-designer-publication/cs_1.png)![call service node with input parameters](/resources/Storage/server-side-service-designer-publication/cs_2.png)
