...
<https://documentation.neutrinos.com/articles/#!pulse-publication/integrate-rule-group>

To integrate a Rule Group, follow the steps below:

1. In the sub-module navigation bar, click **Rule**, then choose Rule Group tab, select a specific rule group to open its details page. On the details page, navigate to the **Deployment** section and click **Download Swagger**.
    ![rule-group-download-swagger](/resources/Storage/pulse-publication/images/rule-group-download-swagger.png)
2. Open the Swagger documentation (import) downloaded from the Reels platform.
    ![swagger-import-rulegroup](/resources/Storage/pulse-publication/images/swagger-import-rulegroup.gif)
    The Swagger for any rule group contains three API endpoints:
    ![swagger-rule-group-end-points](/resources/Storage/pulse-publication/images/swagger-rule-group-end-points.png)
...
The GIF below illustrates how to execute a rule group using Swagger:
 ...
 ![swagger-rulegroup-execute](/resources/Storage/pulse-publication/images/swagger-rulegroup-execute.gif)

[Next Topic](/articles/pulse-publication/integrate-workflow)

[Previous Topic](/articles/pulse-publication/integrate-rule)
