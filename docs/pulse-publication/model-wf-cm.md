...
<https://documentation.neutrinos.com/articles/#!pulse-publication/model-wf-cm>
...
![modelSample.jpg](/resources/Storage/pulse-publication/images/modelSample.jpg)
...
1. Navigate to **Model** editor in the Workflow Studio > In the Visual editor section, click the plus icon as shown in the image below:
    ![workflow-studio-create-attributes](/resources/Storage/pulse-publication/images/workflow-studio-create-attributes.png)
2. In the pop-up window, set the data type, enter the name of the attribute to be created > Click **Create** button.
    ...
    ![](/resources/Storage/pulse-publication/images/workflow-studio-create-attribute-pop-up-screen.png)

The GIF below illustrates adding attributes to a sample project in Workflow Studio.

![workflow-studio-add-attribute-gif](/resources/Storage/pulse-publication/images/workflow-studio-add-attribute-gif.gif)
...
![](/resources/Storage/pulse-publication/images/workflow-studio-visual-and-code-editor.png)

| ![Note](/resources/Storage/pulse-publication/project-trailproject/note.png) | You can create or add individual attributes multiple times, or alternatively, add a complete JSON schema at once. Both panels update automatically to reflect changes made in either one. |
| --- | --- |

The GIF below illustrates how Visual Editor reflects changes when a complete JSON scheme is added.

![workflow-studio-add-complete-json-schema-gif](/resources/Storage/pulse-publication/images/workflow-studio-code-editor-json-complete-gif.gif)
...
![workflow-studio-create-object-gif](/resources/Storage/pulse-publication/images/workflow-studio-create-object-gif.gif)
...
| ![Note](/resources/Storage/pulse-publication/note.png) | Click the '**Plus**' button from the top-right corner on the Visual Editor screen to add individual objects. The '**Plus**' sign next to an object creates a child to that specific object. |
| --- | --- |
...
| ![Warning](/resources/Storage/pulse-publication/warning.png) | Project initialization is mandatory for Enquiry and Filters to function for Workbench users. |
| --- | --- |
...
![workflow-studio-initialize-project-image](/resources/Storage/pulse-publication/images/workflow-studio-initialize-project.png)

| ![Note](/resources/Storage/pulse-publication/project-trailproject/note.png) | The **Initialize Project** button re-appears every time the **JSON schema** or **Visual Editor** reflects a change. |
| --- | --- |
