...
<https://documentation.neutrinos.com/articles/#!pulse-publication/configure-events>
...
1. From the selected object, navigate to the left navigation panel and click Events to open the Events page.
    ![up-hypha-studio-events-page1](/resources/Storage/pulse-publication/images/up-hypha-studio-events-page1.png)
2. Events can be configured for an object under four circumstances in the platform:
    ...
    ![hypha-studio-events-page-event-timing](/resources/Storage/pulse-publication/images/hypha-studio-events-page-event-timing.png)
...
3. After selecting when the event should be triggered, configure the component to be executed. The following component types are supported:
    ![up-hypha-studio-events-page-event-type](/resources/Storage/pulse-publication/images/up-hypha-studio-events-page-event-type.png)
  - API Request
  - Case Service
  - REELS
  - Custom Code
...
1. In Swagger, specify the required parameters to delete triggers that are available or have been created on the platform. The sample fields for which values must be provided are listed below.
    ![data-fabric-hooks-delete-hook](/resources/Storage/pulse-publication/project-hypha/images/data-fabric-hooks-delete-hook.png)
...
[Next Topic](/articles/pulse-publication/page-layout)

[Previous](/articles/pulse-publication/events)
