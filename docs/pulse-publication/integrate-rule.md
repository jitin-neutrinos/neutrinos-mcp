...
<https://documentation.neutrinos.com/articles/#!pulse-publication/integrate-rule>
...
1. In the navigation bar, click **Rule, **then select a specific rule to open its details page. On the details page, navigate to the **Deployment** section and click **Download Swagger**.
    ![rule-download-swagger](/resources/Storage/pulse-publication/images/rule-download-swagger.png)
...
The GIF below illustrates how to execute a rule using Swagger:
 ...
 ![swagger-integrate-rule-execute](/resources/Storage/pulse-publication/images/swagger-integrate-rule-execute.gif)

[Next Topic](/articles/pulse-publication/integrate-rule-group)

[Previous Topic](/articles/pulse-publication/integration)
