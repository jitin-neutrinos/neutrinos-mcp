...
<https://documentation.neutrinos.com/articles/#!pulse-publication/sentiment-analysis-rule>
...
3. In the pop-up window, enter a **Rule Name**, add a **description** for the rule that describes the purpose of the rule or its functionality, and select **Sentiment Analysis** Rule as the Rule Type.
    ![sentiment-analysis-rule](/resources/Storage/pulse-publication/images/rule-add-rule-sentiment-analysis-rule.png)
...
5. When a rule is created, the Rule Details page opens, allowing you to configure the rule. This page displays key information about the rule, including Version, Status, Last Updated date, Created Date, Deployment ID, and more.
    ...
    ![levenshtein-distance-rule-details-page](/resources/Storage/pulse-publication/images/rule-details-sentiment-analysis-rule.png)
...
6. Navigate to the Rule Designer tab > Double-click the Rule name to open the Rule editor. This page contains 3 tabs, namely Rule, Model Editor, and Constants.
    ![designer-levenshtein-distance-rule](/resources/Storage/pulse-publication/images/sentiment-analysis-double-click.gif)
  1. Navigate to the **Model Editor** tab. Use **Add Root** in both the input and output editors to add the necessary input-output keys. For example, define an input key as InputText and output key as Result.
      ![sentiment-analysis-add-roots](/resources/Storage/pulse-publication/images/sentiment-analysis-add-roots.png)
...
![levenshtein-distance-rule-gif](/resources/Storage/pulse-publication/images/rule-sentiment-analysis-rule.gif)
...
You can add a constant using the Add Constant button in the Constant section on the Rule Details page by specifying a key (constant name) and a value.
 ...
 ![sentiment-analysis-add-constant-detailspage](/resources/Storage/pulse-publication/images/sentiment-analysis-add-constant-detailspage.gif)
...
Alternatively, you can add a Constant tab on the Rule Designer page.
 ...
 ![sentiment-analysis-add-constant-designerpage](/resources/Storage/pulse-publication/images/sentiment-analysis-add-constant-designerpage.gif)
...
To use the constant, map it as an input in the text for analysis within the Rule tab. The GIF below illustrates how the constant is used in the Sentiment Analysis rule:
 ...
 ![sentiment-analysis-use-constant](/resources/Storage/pulse-publication/images/sentiment-analysis-use-constant.gif)
...
3. In the pop-up screen, enter the Rule Name, provide a Rule Description, select Formula as the rule type, and click the Create button.
    For example:
    ![sentiment-analysis-usercase-createrule](/resources/Storage/pulse-publication/images/sentiment-analysis-usercase-createrule.png)
...
4. On the **Rule Details** page, navigate to the **Rule Designer** tab and double-click the rule name to open the designer and draft the rule. The designer page contains 3 tabs namely, Rule, Model Editor, and Constants.
    ![sentiment-analysis-usercase-3tabs](/resources/Storage/pulse-publication/images/sentiment-analysis-usercase-3tabs.gif)
5. Navigate to the **Model** tab and create one input and output root. The output will return the similarity index for the two inputs.
    ![sentiment-analysis-usercase-add-roots](/resources/Storage/pulse-publication/images/sentiment-analysis-usercase-add-roots.gif)
6. Once the roots are added, navigate to the **Rule** tab and map the input and output roots.
    ![sentiment-analysis-usercase-map-roots](/resources/Storage/pulse-publication/images/sentiment-analysis-usercase-map-roots.gif)
...
The GIF below illustrates the testing of the Excel rule:
 ...
 ![sentiment-analysis-rule-testing](/resources/Storage/pulse-publication/images/sentiment-analysis-rule-testing.gif)

For more information on testing, see the [Testing](/smart/project-neutrinos-reels/testing) topic.

[Next Topic](/articles/pulse-publication/configurations)

[Previous Topic](/articles/pulse-publication/phonetics-rule)
