...
<https://documentation.neutrinos.com/articles/#!pulse-publication/enquiry-inbox-wb-cm>
...
| ![Note](/resources/Storage/pulse-publication/note.png) | By default, the Enquiry inbox does not fetch or show any information. |
| --- | --- |
...
| ![Note](/resources/Storage/pulse-publication/note.png) | The default structure that can be mapped and searched are Case Instance and Task Instance. |
| --- | --- |
...
![Enquiry inbox applying filter](/resources/Storage/pulse-publication/images/enquiryinbox-filter.gif)
...
![Full text search - Enquiry inbox](/resources/Storage/pulse-publication/images/full-text-search-enquiry.png)
...
![Partial text search - Enquiry Inbox](/resources/Storage/pulse-publication/images/partial-text-search-enquiry.png)

| ![Note](/resources/Storage/pulse-publication/note.png) | The **text search** filter is an additional filter option that can be added in Workflow Studio, in the similar way how other filters are added. |
| --- | --- |
...
| ![Note](/resources/Storage/pulse-publication/note.png) | Partial search functionality supports only string data types and does not accommodate numeric partial searches. |
| --- | --- |
