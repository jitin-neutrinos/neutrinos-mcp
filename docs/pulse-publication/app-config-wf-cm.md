...
<https://documentation.neutrinos.com/articles/#!pulse-publication/app-config-wf-cm>
...
![enable-navigation-guard](/resources/Storage/pulse-publication/images/workflow-studio-config-enable-navigation-guard.gif)
...
| ![Note](/resources/Storage/pulse-publication/project-trailproject/note.png) | If no user groups are specified, or if Default group is selected, all users are visible for reassignment. |
| --- | --- |

The GIF below demonstrates how to assign users from the 'Medium' group for an admin to reassign owned tasks:

![add-user-group](/resources/Storage/pulse-publication/images/workflow-studio-config-app-config-add-user-group.gif)
...
![admin-add-user-group](/resources/Storage/pulse-publication/images/workflow-studio-config-admin-add-user-group.png)
