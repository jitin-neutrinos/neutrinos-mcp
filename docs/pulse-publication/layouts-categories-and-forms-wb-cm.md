...
<https://documentation.neutrinos.com/articles/#!pulse-publication/layouts-categories-and-forms-wb-cm>
...
![Layout-sample-image](/resources/Storage/pulse-publication/images/categories-layout-sample.png)
...
![Categories sample image](/resources/Storage/pulse-publication/images/categories-fullpage.png)
...
| ![Note](/resources/Storage/pulse-publication/note.png) | The Pages that are available on the Home page of the Workbench are referred as Main Pages. See [Navigate Links](/articles/pulse-publication/navigate-links-wb-cm) Links topic for more information. |
| --- | --- |
...
![MinLength and Regex applied](/resources/Storage/pulse-publication/images/minlength-regex.png)
...
![Placeholder and hint text image](/resources/Storage/pulse-publication/images/placeholder-hint-text.png)
...
![Sample Form image](/resources/Storage/pulse-publication/images/sample-form-fullscreen.png)
