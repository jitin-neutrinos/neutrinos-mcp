...
<https://documentation.neutrinos.com/articles/#!ai-hub/properties-1-2-3-4-5-6-7-2>
...
Defined in: [services/classification/text/dto/create-batch.dto.ts:129](https://bitbucket.org/bhivedevs/idp-inference-sdk/src/master/src/services/classification/text/dto/create-batch.dto.ts#lines-129)
...
Defined in: [services/classification/text/dto/create-batch.dto.ts:137](https://bitbucket.org/bhivedevs/idp-inference-sdk/src/master/src/services/classification/text/dto/create-batch.dto.ts#lines-137)

Indicates whether the batch is file-based.
 For text-only classification, this should be `false`.
