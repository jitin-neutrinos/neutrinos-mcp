...
<https://documentation.neutrinos.com/articles/#!ai-hub/properties-1-2-3-4>
...
Defined in: [services/classification/doc/dto/list-results.dto.ts:146](https://bitbucket.org/bhivedevs/idp-inference-sdk/src/master/src/services/classification/doc/dto/list-results.dto.ts#lines-146)

Indicates if this is a merged result group.
...
Defined in: [services/classification/doc/dto/list-results.dto.ts:153](https://bitbucket.org/bhivedevs/idp-inference-sdk/src/master/src/services/classification/doc/dto/list-results.dto.ts#lines-153)

Name of the group (if merged).
...
Defined in: [services/classification/doc/dto/list-results.dto.ts:160](https://bitbucket.org/bhivedevs/idp-inference-sdk/src/master/src/services/classification/doc/dto/list-results.dto.ts#lines-160)

ID of the group (MongoDB ObjectId).

#### Example

```code
"64f1d0e01c9a4f0012ab9999"
```
