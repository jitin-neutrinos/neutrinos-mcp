...
<https://documentation.neutrinos.com/articles/#!ai-hub/properties-1-2-3-4-5-6-7-8-1>
...
`IStartBatchResponse.training_config_id`
...
`IStartBatchResponse.training_id`
...
`IStartBatchResponse.deployment_id`
...
`IStartBatchResponse.callback_url`
...
`IStartBatchResponse.created_at`
...
`IStartBatchResponse.updated_at`
