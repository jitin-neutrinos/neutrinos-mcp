...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/google-storage-bucket-node>
...
3. **Storage Config: **The name of the config.
  ...
  - If you want to configure a new storage config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new storage config. See [Attributes for a new Storage Config](/articles/server-services-designer-9/google-storage/a/newgoogleconfig) to know what are the properties to configure.
