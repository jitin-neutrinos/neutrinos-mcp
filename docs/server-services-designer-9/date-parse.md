...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/date-parse>
...
- **Action:** The action to be performed on the parameters. See [Parse actions](/articles/server-services-designer-9/date-parse/a/h3__929851382) to learn about the actions that can be performed using this node.
