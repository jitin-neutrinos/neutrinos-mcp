...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/publish-node>
...
| ![Information](/resources/Storage/server-services-designer-9/info.png) | See [Amazon documentation](https://docs.aws.amazon.com/sns/latest/api/API_Publish.html) to learn about message attributes. |
| --- | --- |
