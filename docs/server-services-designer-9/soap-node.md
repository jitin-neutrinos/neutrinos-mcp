...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/soap-node>
...
3. **SOAP Config**: The name of the config.
  ...
  - If you want to configure a new Soap config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new Soap config. See [Attributes for a new Soap Config](/articles/server-services-designer-9/soap-node/a/soapconfig) to know what are the properties to configure.
