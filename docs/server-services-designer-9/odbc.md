...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/odbc>
...
- [ODBC](/articles/server-services-designer-9/odbc-node)
- [Transaction](/articles/server-services-designer-9/odbc-transaction-node)

| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node is available from Neutrinos Studio Release 7.7.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs. |
| --- | --- |
