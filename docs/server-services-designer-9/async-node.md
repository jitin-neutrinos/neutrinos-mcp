...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/async-node>
...
| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node is available from Neutrinos Studio release 7.1.0. You can access it from both Server Services Designer and Client Services Designer. |
| --- | --- |
...
1. **Name:** The name of the node. This name will display on the canvas when the node is saved. ![async node properties](/resources/Storage/server-services-designer-9/asyncnode.png)
