...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/issuance-node>
...
- **Collection:** An object containing the payment information. Create an object in the [Script](/articles/server-services-designer-9/script-node) node and pass the object name in this field. The object should contain the following information: Copy CodeJavaScript"collection":
   {
