...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/kafka-producer>
...
3. **Kafka Config: **The name of the config.
  ...
  - If you want to configure a new config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new storage config. See [Attributes for a new Kafka Config](/articles/server-services-designer-9/kafka/a/h3_1756699968) to know what are the properties to configure.
4. **Kafka Producer Config: **The name of the config.
  ...
  - If you want to configure a new config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new Kafka producer config. See [Attributes for a new Kafka producer Config](/articles/server-services-designer-9/kafka-producer/a/h3_1756699968) to know what are the properties to configure.
