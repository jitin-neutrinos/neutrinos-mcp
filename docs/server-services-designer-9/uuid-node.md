...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/uuid-node>
...
| ![](/resources/Storage/server-services-designer-9/info.png) | This node is a common node across the Server Services Designer and Client Services Designer.This node is available from Neutrinos Studio Release 7.4.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs or services in the Server Services Designer. |
| --- | --- |
