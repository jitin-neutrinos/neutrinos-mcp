...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/date-duration>
...
- **Action:** The action to be performed on the parameters. See [Duration Actions](/articles/server-services-designer-9/date-duration/a/h3_825119271) to learn about the actions that can be performed using this node.
