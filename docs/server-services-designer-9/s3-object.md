...
3. **Select AWS Config: **The name of the config that connects to the **AWS Server**.
  ...
  - If you want to configure a new textract config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new textract config. See [Attributes for a new AWS Config](/articles/server-services-designer-9/aws-s3/a/newawsconfig) to know what are the properties to configure.
