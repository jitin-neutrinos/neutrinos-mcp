...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/agenda-node>
...
| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node is available from Neutrinos Studio Release 7.5.0.Download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs or services in the Server Services Designer. |
| --- | --- |
...
3. **Agenda Config: **The name of the configuration to connect to a MongoDB database.
  ...
  - If you want to add a new configuration, select **Add new config** from the drop-down list and click the **Map** icon. See [Attributes for a new configuration](/articles/server-services-designer-9/agenda-node/a/h3_931954325) to learn about the properties.
...
![Agenda priority mapping](/resources/Storage/server-services-designer-9/agenda_priority.png)
