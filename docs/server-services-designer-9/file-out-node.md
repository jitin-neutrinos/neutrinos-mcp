...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/file-out-node>
...
- **Name****: **Unique name for the node. This name will display on the canvas when you save the node.![file out properties](/resources/Storage/server-services-designer-9/fileoutnew.png)
