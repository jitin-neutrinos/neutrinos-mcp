...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/communication>
...
- [Tele Call node](/articles/server-services-designer-9/tele-call-node)
- [Get Call Recording](/articles/server-services-designer-9/get-call-recording-node)
- [Get Instance](/articles/server-services-designer-9/get-instance-node)

| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node package internally uses the Nexmo npm package. See the [Nexmo documentation](https://www.npmjs.com/package/nexmo) to learn more. |
| --- | --- |
...
| ![Information](/resources/Storage/server-services-designer-9/info.png) | To get the API Key, API Secret, and the Application ID, you should create a developer account on Nexmo (Vonage). See [https://dashboard.nexmo.com/sign-up](https://dashboard.nexmo.com/sign-up) . |
| --- | --- |
