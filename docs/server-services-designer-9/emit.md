...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/emit>

The **Emit node** allows you to emit an event from anywhere in the app. You use the [Listen node](/articles/server-services-designer-9/listen) to listen to the event.

| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node is available from Neutrinos Studio Release 7.4.0. |
| --- | --- |
