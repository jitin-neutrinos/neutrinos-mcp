...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/log-node>
...
- **Name:** A unique name for the node. This name will display on the canvas when you save the node. ![Log node properties](/resources/Storage/server-services-designer-9/lognode.png)
