...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/sftp-get>
...
3. **Select SFTP Config: **The name of the config that connects to the **SFTP Server**.
  ...
  - If you want to configure a new textract config, select **Add new config** from the drop-down list and click the **Map** icon to configure a new SFTP config. See [Attributes for a new SFTP Config](/articles/server-services-designer-9/ftp/a/newsftpconfig) to know what are the properties to configure.
