...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/configure-oracle-database>
...
After entering the required values, click ![](/resources/Storage/server-services-designer-9/correct.png) to save the connection details. You will see the connection listed in the **Database Config** field.
