...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/date-get-set>
...
- **Action:** The action to be performed on the parameters. See [Get Set Actions](/articles/server-services-designer-9/date-get-set/a/h3__1710304451) to learn about the actions that can be performed using this node.
