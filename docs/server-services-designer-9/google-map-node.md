...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/google-map-node>
...
3. **Google Config:**The name of the configuration that connects to the Google APIs.
  ...
  - If you want to create a new Google configuration, select **Add new config** from the drop-down list and click the **Map** icon to add a new configuration. See [Attributes for a new Google Config](/articles/server-services-designer-9/google-map-node/a/googleconfig_map) to learn about the properties to configure.
