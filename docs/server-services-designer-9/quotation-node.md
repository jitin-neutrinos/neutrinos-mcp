...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/quotation-node>
...
- **Policy: **An object containing the policy information of the customer. Create an object in the [Script](/articles/server-services-designer-9/script-node) node and pass the object name in this field. The object should contain the following information:Copy CodeJavaScript"policy": {
    "customers": [],
