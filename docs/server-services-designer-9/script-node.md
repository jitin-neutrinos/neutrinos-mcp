...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/script-node>
...
You can also use the bh. object in the editor to access all the properties. See [Properties](/articles/server-services-designer-9/properties-in-server-services) for a complete list.

- Add your business logic in the editor and click the ![](/resources/Storage/server-services-designer-9/correct.png) button.
