...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/email-out-node>
...
1. Login to your Gmail account. Click the **Gear** icon on the right to change the mail settings and select** Settings**.
    ![Gmail Settings](/resources/Storage/server-services-designer-9/gmail_settings.png)
2. In the Settings editor, select **Forwarding and POP/IMAP** settings.
    ![email settings](/resources/Storage/server-services-designer-9/emailsettings.png)
3. Enable **POP **and** IMAP **settings. Save the changes.
    ![imap and pop settings](/resources/Storage/server-services-designer-9/IMAPandPOP.png)
4. Navigate to the **Account Settings** and select **Security**.
    ![account settings 1](/resources/Storage/server-services-designer-9/accountsettings1.png) ![account settings 2](/resources/Storage/server-services-designer-9/accountsettings2.png)
5. Scroll down and enable the **Less secure app access**.
    ![account settings 3](/resources/Storage/server-services-designer-9/AS3.png)
...
- **Host**: The hostname or the IP address of the mail provider. For example, the hostname for Gmail is **smtp.gmail.com **and for outlook is** smtp-mail.outlook.com. ![email out attributes](/resources/Storage/server-services-designer-9/Emailout1.png)**
...
- **From**: The email address of the sender.
  ...
  - If you are using the mail providers other than Outlook or Hotmail, you can enter any other email address in this field. By default, it takes the email address from the Mail configuration.
     ![email basic fields](/resources/Storage/server-services-designer-9/emailbasic.png)
...
You can also click the plus ![](/resources/Storage/server-services-designer-9/designing-data-models-2019-05-31.png)icon and enter the following fields to add an attachment:

- **Filename**: The name of the file that you want to attach the email. Make sure you specify the Extension of the file. ![attachment options for email out](/resources/Storage/server-services-designer-9/attchmentiptions.png)For example, if the file is an image of the jpeg format, then the extension should be **img****.jpeg**.
