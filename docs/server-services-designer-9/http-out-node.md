...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/http-out-node>
...
- Option include:
  ...
  - **Same Site(Boolean or String)**: The **Same Site** prevents the browser from sending the cookie along with cross-site requests.
- **Select Data Model: **Allows you to select data model information to be sent as a response.
  - **Send Array of Selected Entity: **When this toggle is enabled, allows array of entity objects to be sent in the response body.
  - **Data Model: **Enables you to select the data model.
  - **Entity: **Based on the data model you have selected, displays a list of entities pertaining to the data model.
