...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/cosmosdb-node>
...
- [Item node](/articles/server-services-designer-9/item-node)
- [Container node](/articles/server-services-designer-9/container-node)

| ![Information](/resources/Storage/server-services-designer-9/info.png) | This node is available from Neutrinos Studio Release 7.7.0.You have to download this node from the**[Neutrinos Store](https://store.neutrinos.co/web/catalog/featured)** to use it in your APIs or services in the Server Services Designer. |
| --- | --- |
