...
<https://documentation.neutrinos.com/articles/#!server-services-designer-9/amqp-producer-node>
...
- **AMQP Config: **The name of the AMQP producer configuration. ![AMQP Connection](/resources/Storage/server-services-designer-9/amqp_conn.png)
...
- **Producer Queue: **The queue to which the message is to be sent. ![AMQP node](/resources/Storage/server-services-designer-9/amqp3.png)
...
- **Name: **The name of the AMQP producer configuration.![A new AMQP producer configuration](/resources/Storage/server-services-designer-9/amqp2.png)
