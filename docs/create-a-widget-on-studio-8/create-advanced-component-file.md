...
<https://documentation.neutrinos.com/articles/#!create-a-widget-on-studio-8/create-advanced-component-file>
...
| ![Information](/resources/Storage/create-a-widget-on-studio-8/info.png) | The naming convention should be {compane-name}{package-name}{component-name}. |
| --- | --- |
...
| ![Information](/resources/Storage/create-a-widget-on-studio-8/info.png) | If you add attribute types for your component, you have to import the same in your** index.js** file. |
| --- | --- |
...
- [Define the designerTemplate using slots](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4_148746544)
- [Style the elements inside the slot](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4__981283192)
- [Listen to the HTML events on your element](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4__386328029)
- [Attach children or siblings to the component](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4__1759985169)
- [Share objects between parent and child elements](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4__1727228971)
- [Disable element copy](/articles/create-a-widget-on-studio-8/create-advanced-component-file/a/h4_1043266511)
