...
<https://documentation.neutrinos.com/articles/#!project-plugins-builder-guide/node-utils>
...
![](/resources/Storage/project-plugins-builder-guide/utils.png)
...
2. Find the method by the name **[generateImports](/articles/project-plugins-builder-guide/code-generation/a/h4_1584156788). **Define this method if not found.
...
1. In the **Code Generation** editor, find the method by the name **[generateSnippet](/articles/project-plugins-builder-guide/code-generation/a/h3_2122082004). **Define this method if not found.
