...
<https://documentation.neutrinos.com/articles/#!plugins-builder-guide-8/node-attributes>
...
4. **Select ****Attribute ****Type**: Define the type of the attribute. See [Types of Node Attributes](/articles/plugins-builder-guide-8/node-attributes/a/h3__668741143) to learn more.
...
![node name](/resources/Storage/plugins-builder-guide-8/node_name.png)
...
![](/resources/Storage/plugins-builder-guide-8/server%20node%20test2.png)

![Dummy server node](/resources/Storage/plugins-builder-guide-8/server%20node%20test.png)
...
![value of another node attribute](/resources/Storage/plugins-builder-guide-8/schedule_value.png)

![node label](/resources/Storage/plugins-builder-guide-8/schedult_node_label.png)
...
- **Page Variable** - This field is visible only when you are creating a **page** node. See [Properties in Page Designer](/smart/project-page-services-designer-guide/properties-page-designer) to learn about the page variable and what it includes. If you are creating a common node to appear on [Page designer](/smart/project-concepts/page-designer), [Client Services Designer](/smart/project-concepts/client-services-designer), and [Server Services Designer](/smart/project-concepts/server-services-designer), the typed Input - **page variable** will not be available for selection. You have to create a separate page node to use this typed input.
...
![](/resources/Storage/plugins-builder-guide-8/select%20type1.png)
...
![](/resources/Storage/plugins-builder-guide-8/toggle%20type.png)
...
![](/resources/Storage/plugins-builder-guide-8/amqp%20config.png)
