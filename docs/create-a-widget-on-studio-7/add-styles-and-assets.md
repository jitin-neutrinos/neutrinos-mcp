...
<https://documentation.neutrinos.com/articles/#!create-a-widget-on-studio-7/add-styles-and-assets>

You have already created the studio package and component(s) by following the steps mentioned in the below topics:

- [Create a Studio Package](/articles/create-a-widget-on-studio-7/create-a-studio-package)
- [Create a Component](/articles/create-a-widget-on-studio-7/create-component-file) or [Create an Advanced Component](/articles/create-a-widget-on-studio-7/create-advanced-component-file)
...
1. [Add assets](/articles/create-a-widget-on-studio-7/add-styles-and-assets/a/addassets)
2. [Add styles](/articles/create-a-widget-on-studio-7/add-styles-and-assets/a/addstyles)
