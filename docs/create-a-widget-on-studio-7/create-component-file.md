...
<https://documentation.neutrinos.com/articles/#!create-a-widget-on-studio-7/create-component-file>

### Create the Component File

| ![Information](/resources/Storage/create-a-widget-on-studio-7/info.png) | Make sure you reread the steps multiple times and verify the contents of the component file. |
| --- | --- |
...
| ![Information](/resources/Storage/create-a-widget-on-studio-7/info.png) | The name of the component should be prefixed with the package name. For example: **const name = 'NG-area-chart';** |
| --- | --- |
...
![Area Chart properties](/resources/Storage/create-a-widget-on-studio-7/area1.png)
