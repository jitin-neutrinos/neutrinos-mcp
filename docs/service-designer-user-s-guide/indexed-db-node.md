...
<https://documentation.neutrinos.com/articles/#!service-designer-user-s-guide/indexed-db-node>
...
- [Connect](/articles/service-designer-user-s-guide/connect-node)
- [Transaction](/articles/service-designer-user-s-guide/transaction-node)
- [Cursor](/articles/service-designer-user-s-guide/cursor-node)
- [Insert](/articles/service-designer-user-s-guide/insert-node)
- [Upsert](/articles/service-designer-user-s-guide/upsert-node)
- [Get](/articles/service-designer-user-s-guide/get-node)
- [Remove](/articles/service-designer-user-s-guide/remove-node)

To work with IndexedDB, you should open a connection to your database, and then perform operations on the data.

| ![Information](/resources/Storage/service-designer-user-s-guide/info.png) | These nodes are available from Neutrinos Studio version 7.7.0. Get familiar with the [IndexDB concepts](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Basic_Concepts_Behind_IndexedDB#gloss_transaction) before you work with them. |
| --- | --- |
