# bh.system.loginService Resolver

<https://documentation.neutrinos.com/articles/#!service-designer-user-s-guide/system-loginservice>
...
**Methods:**
 ...
 [login()](/articles/service-designer-user-s-guide/system-loginservice/a/login)[isLoggedIn()](/articles/service-designer-user-s-guide/system-loginservice/a/isLoggedIn) **Variables:**
 loginUrl: Neutrinos Art authentication URL if the application is migrated from previous versions of Studio which used Neutrinos Art.
  ...
  systemService: [system.deviceService](/articles/service-designer-user-s-guide/system-deviceservice)
  nSessionStorage: [NSessionStorageService](/articles/service-designer-user-s-guide/system-sessionstorageservice)
