...
<https://documentation.neutrinos.com/articles/#!psd-tutorial-publication/create-routes-and-add-styles>

| ![Information](/resources/Storage/psd-tutorial-publication/tutorial-create-a-leave-management-system/info.png) | You should create application pages before you start configuring routes. |
| --- | --- |

**Creating and configuring Routes**

To create and configure [routes](/smart/project-sample-how-to-guide/adding-routes), click the **Route** icon.

![Add routes](/resources/Storage/psd-tutorial-publication/tutorial-create-a-leave-management-system/routes.png)
...
Configure the following routes for the weather app:
...
Replace the styles editor with this CSS:
