...
<https://documentation.neutrinos.com/articles/#!alpha-platform/language-editor>
...
![language-add-gif](/resources/Storage/alpha-platform/images/workflow-studio-config-language-add-gif.gif)

| ![Note](/resources/Storage/alpha-platform/project-trailproject/note.png) | If a language has an RTL (Right-to-Left) orientation, the entire application layout adapts accordingly. This means the application switches to an RTL layout to match the language. |
| --- | --- |
...
4. Select the attribute, choose **Language** from the dropdown, and then select the appropriate key from the available list.
    ![orkflow-studio-language-direct](/resources/Storage/alpha-platform/images/workflow-studio-language-1.png)
    ...
    ![workflow-studio-language-using-{{}}](/resources/Storage/alpha-platform/images/workflow-studio-language-2.png)
...
![language-add-workbench-gif](/resources/Storage/alpha-platform/images/workflow-studio-config-language-add-workbench-gif.gif)
