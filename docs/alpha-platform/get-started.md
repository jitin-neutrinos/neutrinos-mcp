...
<https://documentation.neutrinos.com/articles/#!alpha-platform/get-started>
...
![workflow-studio-projects page](/resources/Storage/alpha-platform/images/workflow-studio-projectspage.png)
...
3. **Case Type**: Displays the Case Type. It is the same as the case type from Case Service. To know more on Case Onboarding, see [Onboarding](/articles/alpha-platform/onboard-process-and-case) topic.
...
| ![Note](/resources/Storage/alpha-platform/note.png) | Developers can search or filter the projects in the Workflow Studio using the search or filter options that is available in the UI. |
| --- | --- |
...
![workflow-studio-create-project-gif](/resources/Storage/alpha-platform/images/workflow-studio-create-project-gif.gif)

| ![Note](/resources/Storage/alpha-platform/project-trailproject/note.png) | A single Case Type can be linked to multiple projects. |
| --- | --- |
...
![alpha-dev-mode-active-screen-shot](/resources/Storage/alpha-platform/images/alpha-dev-mode-active-screen-shot.png)
