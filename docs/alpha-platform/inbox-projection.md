...
<https://documentation.neutrinos.com/articles/#!alpha-platform/inbox-projection>
...
| ![Note](/resources/Storage/alpha-platform/project-trailproject/note.png) | All case and task instances are directly accessible from the custom code. However, if a key or field is of type CO, it must be **explicitly **specified as part of the Inbox Projection to make it accessible within the custom code. |
| --- | --- |
...
![alpha-inbox-projection](/resources/Storage/alpha-platform/images/alpha-inbox-projection.gif)
