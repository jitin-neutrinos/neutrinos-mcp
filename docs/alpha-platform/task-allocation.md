...
<https://documentation.neutrinos.com/articles/#!alpha-platform/task-allocation>
...
1. **Select Tasks**:
  ...
  - Click the** Reassign **button.
      ![ASsign-task-1](/resources/Storage/alpha-platform/images/assign-task-step1.png)
2. **Assign to a User**:
  - On the **Reassign Tasks** page, click the **Assign **dropdown.
      ![assign-task-2](/resources/Storage/alpha-platform/images/assign-task-step2.png)
  - From the list of available users, search for or select the user ID of the intended assignee.
  - Click the **Confirm **button.
      ![assign-task-3](/resources/Storage/alpha-platform/images/assign-task-step3.png)
  ...
  - Click the **Next **button to review the case details and the **New Assignee** field.
      ![assign-task-4](/resources/Storage/alpha-platform/images/assign-task-step5.png)
...
4. **Return to Inbox**: Click the **Back to Inbox** button to return to the **My Tasks** Inbox page.
    ![assign-task- confirm](/resources/Storage/alpha-platform/images/assign-task-step-confirmation.png)
...
The flow diagram illustrates the process flow in automated task distribution:
 ...
 ![task distribution system flow](/resources/Storage/alpha-platform/images/task-distribution-system.jpg)
