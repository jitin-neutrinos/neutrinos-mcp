...
<https://documentation.neutrinos.com/articles/#!alpha-platform/navigation-editor>
...
![navigation-mainmenu-headers](/resources/Storage/alpha-platform/images/navigation-mainmenu-headers.png)
...
![main-menu-add-gif](/resources/Storage/alpha-platform/images/workflow-studio-config-main-menu-add-gif.gif)
...
![header-add-gif](/resources/Storage/alpha-platform/images/workflow-studio-config-header-add-gif.gif)

| ![Note](/resources/Storage/alpha-platform/project-trailproject/note.png) | The toggle at the end of each header row controls whether the header URL opens in a new tab. By default, the URL opens in the same tab. Enabling the toggle will open it in a new tab. |
| --- | --- |
