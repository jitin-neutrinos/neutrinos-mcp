...
<https://documentation.neutrinos.com/articles/#!client-services-designer-8/is-online-node>
...
| ![Warning](/resources/Storage/client-services-designer-8/warning.png) | This event shouldn't be used to determine the availability of a particular website. Network problems or firewalls might still prevent the website from being reached. |
| --- | --- |
...
3. **Result Mapping:** The result of the event. Enter the [flow object](/articles/client-services-designer-8/service-designer-variables)in which you want to save the result. Example:![](/resources/Storage/client-services-designer-8/online.PNG)
