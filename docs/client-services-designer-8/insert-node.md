...
<https://documentation.neutrinos.com/articles/#!client-services-designer-8/insert-node>

The** Insert** node is used to insert a record into an object store in the [IndexedDB](/articles/client-services-designer-8/indexeddb-nodes) database.
