...
<https://documentation.neutrinos.com/articles/#!client-services-designer-8/zone-node>

A **Zone **node is used to execute synchronous tasks inside and outside the angular zone. An Angular zone is an execution context that persists across async tasks.
