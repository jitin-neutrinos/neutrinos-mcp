...
<https://documentation.neutrinos.com/articles/#!client-services-designer-8/get-node>

The** Get** node is used to fetch specific records from an object store in the [IndexedDB](/articles/client-services-designer-8/indexeddb-nodes) database.
...
9. **Result Mapping:** The result of the operation. Enter the [flow object](/articles/client-services-designer-8/service-designer-variables)in which you want to save the result.
