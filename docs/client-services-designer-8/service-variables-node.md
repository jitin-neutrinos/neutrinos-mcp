...
<https://documentation.neutrinos.com/articles/#!client-services-designer-8/service-variables-node>
...
2. **Function Name: **This is a read-only field. The function name is generated based on the name that you enter in the Name field. It is used to identify the node while debugging.
3. **Operation Type: **The type of operation the node should perform.
