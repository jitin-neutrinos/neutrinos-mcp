...
<https://documentation.neutrinos.com/articles/#!neutrinos-reels-publication/flow-lines>
...
1. **Exclusive Gateway (XOR Gateway)**: Used when only one path can be taken among multiple possible paths as shown in the below GIF:
    ![pulse-exclusive-gateway-flowline](/resources/Storage/neutrinos-reels-publication/images/pulse-exclusive-gateway-flowline.gif)
...
2. Navigate to the flowline for which a condition needs to be added. Click on the Flowline, add the following details:
    ![pulse-exclusive-gateway-add-flow-values](/resources/Storage/neutrinos-reels-publication/images/pulse-exclusive-gateway-add-flow-values.gif)
...
[Next Toopic](/articles/neutrinos-reels-publication/user-tasks)

[Previous Topic](/articles/neutrinos-reels-publication/nodes)
