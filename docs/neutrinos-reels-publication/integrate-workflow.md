...
<https://documentation.neutrinos.com/articles/#!neutrinos-reels-publication/integrate-workflow>

To integrate a Workflow, follow the steps below:

1. In the navigation bar, click **Workflow**, then choose a specific workflow to open its details page. On the details page, navigate to the **Deployment** section and click **Download Swagger**.
    ![workflow-download-swagger](/resources/Storage/neutrinos-reels-publication/images/workflow-download-swagger.png)
2. Open the Swagger documentation (import) downloaded from the Reels platform.
    ![swagger-import-workflow](/resources/Storage/neutrinos-reels-publication/images/swagger-import-workflow.gif)
    The Swagger for any workflow contains three API endpoints:
    ![swagger-workflow-endpoints](/resources/Storage/neutrinos-reels-publication/images/swagger-workflow-endpoints.png)
...
The GIF below illustrates how to execute a workflow using Swagger:
 ...
 ![swagger-execute-workflow](/resources/Storage/neutrinos-reels-publication/images/swagger-execute-workflow.gif)

[Next Topic](/articles/neutrinos-reels-publication/integrate-master-data)

[Previous Topic](/articles/neutrinos-reels-publication/integrate-rule-group)
