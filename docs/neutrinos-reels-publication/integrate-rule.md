...
<https://documentation.neutrinos.com/articles/#!neutrinos-reels-publication/integrate-rule>

To integrate a Rule, follow the steps below:

1. In the navigation bar, click **Rule, **then select a specific rule to open its details page. On the details page, navigate to the **Deployment** section and click **Download Swagger**.
    ![rule-download-swagger](/resources/Storage/neutrinos-reels-publication/images/rule-download-swagger.png)
...
The GIF below illustrates how to execute a rule using Swagger:




 ![swagger-integrate-rule-execute](/resources/Storage/neutrinos-reels-publication/images/swagger-integrate-rule-execute.gif)

[Next Topic](/articles/neutrinos-reels-publication/integrate-rule-group)

[Previous Topic](/articles/neutrinos-reels-publication/integration)
