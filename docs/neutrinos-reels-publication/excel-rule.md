...
<https://documentation.neutrinos.com/articles/#!neutrinos-reels-publication/excel-rule>
...
3. In the pop-up window, enter a **Rule Name**, add a **description** for the rule that describes the purpose of the rule or its functionality, and select **Excel** Rule as the Rule Type.
    ![add-excel-rule](/resources/Storage/neutrinos-reels-publication/images/rule-add-excel-rule.png)
...
5. When a rule is created, the Rule Details page opens, allowing you to configure the rule. This page displays key information about the rule, including Version, Status, Last Updated date, Created Date, Deployment ID, and more.
    ...
    ![excel-rule-details-page](/resources/Storage/neutrinos-reels-publication/images/rule-details-excel-rule.png)
...
6. Navigate to the Rule Designer tab > Double-click the Rule name to open the Rule editor. This page contains 3 tabs, namely Rule, Model Editor, and Constants.
    ![designer-excel-rule](/resources/Storage/neutrinos-reels-publication/images/excel-rule-doubleclick-designer.gif)
  ...
  3. Click the Model Editor tab > Add necessary input-output keys using **Add Root** in both input and output editors.
      ![excel-rule-add-roots](/resources/Storage/neutrinos-reels-publication/images/excel-rule-add-roots.png)
  ...
  4. Switch back to the **Rule** tab and map the keys defined in the previous step to the target input and output fields.
      ![excel-rule-map-keys](/resources/Storage/neutrinos-reels-publication/images/excel-rule-map-keys.png)
...
![excel-rule-gif](/resources/Storage/neutrinos-reels-publication/images/rule-excel-rule.gif)
...
You can add a constant using the **Add Constant** button in the **Constant** section on the **Rule Details** page by specifying a key (constant name) and a value.
 ...
 ![excel-rule-add-constant-ruledetails](/resources/Storage/neutrinos-reels-publication/images/excel-rule-add-constant-ruledetails.gif)
...
Alternatively, you can add a constant from the Constant tab on the Rule Designer page.
 ...
 ![excel-rule-add-constant-designer](/resources/Storage/neutrinos-reels-publication/images/excel-rule-add-constant-designer.gif)
...
To use a constant, map the constant created in the platform to the fields declared in the Excel sheet. The GIF below demonstrates how to map a platform-defined constant to a field specified in the Excel sheet.
 ...
 ![excel-rule-constant-mapping](/resources/Storage/neutrinos-reels-publication/images/excel-rule-constant-mapping.gif)
...
![configure-excel](/resources/Storage/neutrinos-reels-publication/images/configure-excel-excel-rule.gif)

The configured Excel sheet can now be integrated for use in the Excel Rule. Click [here](/resources/Storage/neutrinos-reels-publication/Excel-Rule-excelsheet/ExcelRuleSheet-Sample.xlsx) to download the Excel file created in the above steps.
...
The GIF below illustrates how to integrate the Excel sheet into the Excel Rule to calculate the total discount and premium discount for an input base premium.
 ...
 ![excel-rule-integrate-excel-to-rule](/resources/Storage/neutrinos-reels-publication/images/excel-rule-integrate-excel-to-rule.gif)
...
The GIF below illustrates the testing of the Excel rule:
 ...
 ![excel-rule-testing](/resources/Storage/neutrinos-reels-publication/images/excel-rule-testing.gif)

For more information on testing, see the [Testing](/articles/neutrinos-reels-publication/testing) topic.

[Next Topic](/articles/neutrinos-reels-publication/api-rule)

[Previous Topic](/articles/neutrinos-reels-publication/decision-tree)
