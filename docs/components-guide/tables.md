...
<https://documentation.neutrinos.com/articles/#!components-guide/tables>
...
Copy CodeJavaScript// Data table configuration (Sample Data)
PeriodicElement = [
 {
...
- Open the attribute window of each column and input in the `mapping` field.
...
- **Show Header:** It allows you to choose if you want to show the Table's header or not. Choose `True` of `False.`
