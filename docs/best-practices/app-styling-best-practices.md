# App Styling Best Practices

<https://documentation.neutrinos.com/articles/#!best-practices/app-styling-best-practices>
...
| ![Information](/resources/Storage/best-practices/info.png) | While using selector nesting, do not nest more than 3 to 4 levels. |
| --- | --- |

VariablesSCSS allows you to work with variables. These variables start with a dollar sign ($) and are different from CSS variables that start with a double dash. We recommend that you define the most common values using variables before starting any project in Neutrinos Studio. For example: ![Defining variables in the Styles editor](/resources/Storage/best-practices/styles_variables.png)CommentsAlways write section-wise comments. It helps you organize the styles in your stylesheet and quickly make changes as styles start getting bigger. For example:Copy CodeCSS/*START: Login Page */
