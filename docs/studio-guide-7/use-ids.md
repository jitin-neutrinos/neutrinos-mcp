...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/use-ids>
...
![](/resources/Storage/studio-guide-7/ODS_warning.png)
...
2. Configure the **Routes** editor with the page that you have called in the login() method.
    ![Routes editor](/resources/Storage/studio-guide-7/home_routes.png)

**Redirecting app users post logout:**

| ![Information](/resources/Storage/studio-guide-7/info.png) | This feature is available from version 7.1.0 of Neutrinos Studio. |
| --- | --- |
