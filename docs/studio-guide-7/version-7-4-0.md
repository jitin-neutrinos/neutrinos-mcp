...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/version-7-4-0>

Here is a list of new features and enhancements introduced in Neutrinos Studio version 7.4.0:

### Server Services Designer

The following are the nodes added to the Server Services Designer:
...
Neutrinos release 7.4.0 provides you an editor and allows you to configure the IDS UI.

Added a new editor for the IDS UI configuration.

Added a Settings editor UI to skip consent and shared client info.

Refer to the [ChangeLog](/smart/project-change-log/release-7-4-0) to learn about the bug fixes.
