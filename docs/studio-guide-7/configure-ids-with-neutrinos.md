...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/configure-ids-with-neutrinos>
...
![Neutrinos IDS](/resources/Storage/studio-guide-7/neutrinos_ids.png)
...
- Create and manage **Teams** on Neutrinos Console to authorize users based on roles. See [Manage Teams](/articles/studio-guide-7/manage-teams).
