...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/creating-an-app>
...
- Use the** Plugins** option on the top menu to [download existing app plugins](/articles/studio-guide-7/import-plugin) to your workspace. Plugins downloaded on the workspace can be applied to any app.
...
![edit app window](/resources/Storage/studio-guide-7/edit_app_details.png)
