...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/before-you-begin>
...
| ![Information](/resources/Storage/studio-guide-7/info.png) | Starting from Neutrinos Studio 7.6.0, Angular CLI is not a prerequisite to run the front-end. |
| --- | --- |
...
See [Setup Proxy on Neutrinos Studio](/articles/studio-guide-7/setup-proxy-on-neutrinos-studio) to learn more.
