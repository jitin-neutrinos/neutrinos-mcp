...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/ids-with-cloud-deployment>
...
3. Locate your application card. Once the app is successfully deployed, click the **Web Link**. ![App web link](/resources/Storage/studio-guide-7/web_link.png)
...
6. Update the Logout Redirect URI with **<web_link>/api/logout/cb**.![Login and logout redirect URIs](/resources/Storage/studio-guide-7/login_logout_redirect.png)
7. Save your app
