...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/configure-ids-with-active-directory>
...
![Active Directory IDS](/resources/Storage/studio-guide-7/Active%20Directoy_ids.png)
...
- Import and use the IDS module in your application. See [Using the IDS Module](/articles/studio-guide-7/use-ids).
- To give users access to the app, create **Teams** and onboard** U****sers **on Neutrinos Console. You should have the **organisation admins** privilege to perform this operation. See [User Management](/articles/studio-guide-7/perform-user-management).
