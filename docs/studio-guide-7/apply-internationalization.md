...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/apply-internationalization>

Add multi-lingual support for your application by using the **Locales** Editor. Access the **Locales** editor from the side pane.

![locales editor](/resources/Storage/studio-guide-7/locales.png)
 ...
 **Step 1: Adding a locale-specific key**
 ...
 ![Key and value in the Locales editor](/resources/Storage/studio-guide-7/i18n_key.png)
 ...
 ![The languages drop-down list](/resources/Storage/studio-guide-7/i18n_lang_selected.png)
 ...
 ![Default language selection](/resources/Storage/studio-guide-7/i18_def_lang.png)
 ...
 **Step 2: Bind the key to a component**
 ...
 ![Attributes window of a button](/resources/Storage/studio-guide-7/btn_setting.png)

 On deployment, the button name looks like this:

 ![Translated button](/resources/Storage/studio-guide-7/translated_btn.png)
 ...
 ![Toggle button setting](/resources/Storage/studio-guide-7/toggle_setting.png)
...
Add the following code to the TS editor of the page. This code toggles the button name between Arabic and English.
 ...
 ![Toggle between two languages](/resources/Storage/studio-guide-7/toggle_1.png)
