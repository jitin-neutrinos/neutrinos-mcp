...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/version-7-7-0>
...
From Neutrinos Studio version 7.7.0, you can [convert any app to a PWA](/articles/studio-guide-7/convert-to-progressive-web-app) using the PWA editor. After converting the app, you can:

- Change the appearance of the app by using the **Appearance** editor.
- [Cache URLs in Service Worker](/articles/studio-guide-7/cache-url) by using the **Cache Config **editor.
