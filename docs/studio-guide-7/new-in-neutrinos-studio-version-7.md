...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/new-in-neutrinos-studio-version-7>
...
Neutrinos performs both, authentication and authorization of apps after the IDS is enabled. See [Configure IDS](/articles/studio-guide-7/configure-your-ids) to learn more about IDS configuration.
...
The Neutrinos Studio translator converts the keyword to the language of your choice and displays it on the screen. See [Localization](/articles/studio-guide-7/apply-internationalization) to learn more.

### Logger Settings

Neutrinos Studio allows you to configure logger settings for the server apps that you create using Neutrinos Studio. Log files are useful in debugging and auditing applications and their flows. To access Logger settings, click **Settings** on Neutrinos Studio and select **Logger**. See [Logger settings](/articles/studio-guide-7/configure-logger) to learn more.
...
See [Perform User Management](/articles/studio-guide-7/perform-user-management) to learn more.
...
See [Configure PM2](/articles/studio-guide-7/configure-pm2) to learn more.
