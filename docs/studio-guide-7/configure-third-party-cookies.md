...
<https://documentation.neutrinos.com/articles/#!studio-guide-7/configure-third-party-cookies>
...
| ![Information](/resources/Storage/studio-guide-7/info.png) | The cookies set on the mobile app are always considered to be third-party cookies if the hostname is not given in the **config.xml** file. |
| --- | --- |
