...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/accessing-environment-properties>
...
Create or open a page. On the HTML editor of the page, drag and drop a **Toolbar** component to the canvas.
 ...
 ![toolbar properties](/resources/Storage/studio-guide-8/appname_toolbar.png)



 On preview, the app name is displayed on the toolbar:

 ![app name on the toolbar](/resources/Storage/studio-guide-8/appname.png)
...
Open the **Environments **Editor.
 ...
 ![adding an env property](/resources/Storage/studio-guide-8/add_env_prop.png)
 ...
 **Step 3: Bind the Page Flow to the Page UI**
 ...
 (click): Click the **Pick a Flow **mat chip and select the** call API **flow in the Flow Picker editor. See [Bind Page Flows to Components](/articles/studio-guide-8/bind-page-flows-to-components) to learn more about Flow Picker.
 ...
 ![binding the API response to the Div](/resources/Storage/studio-guide-8/apires_html.png)
 ...
 ![Preview of the app](/resources/Storage/studio-guide-8/env_preview.png)
