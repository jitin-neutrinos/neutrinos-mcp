...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/use-mobile-plugins>

A **Mobile Plugin** is an add-on code that provides a JavaScript interface to native components. They allow your app to use native device capabilities beyond what is available to pure web apps.
...
![platform cordova](/resources/Storage/studio-guide-8/platforms.png)
