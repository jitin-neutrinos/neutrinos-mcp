...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/what-is-an-environment>
...
![Environments editor](/resources/Storage/studio-guide-8/Envi7.png)
...
- Click ![the Clone icon](/resources/Storage/studio-guide-8/clone_icon.png) next to the environment that you want to clone.
