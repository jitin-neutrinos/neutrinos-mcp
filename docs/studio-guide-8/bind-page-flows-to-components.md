...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/bind-page-flows-to-components>
...
4. ![Flow picker](/resources/Storage/studio-guide-8/flow_pickwer1.png)
...
6. ![Flow picker](/resources/Storage/studio-guide-8/flow_pickwer2.png)
...
2. Create a custom property of type **key&value**. See [Work with Component Properties](/articles/studio-guide-8/work-with-component-properties).
3. Click the Pick a Flow mat chip to open the **Flow Picker **editor and select a page flow.

| ![Information](/resources/Storage/studio-guide-8/info.png) | You cannot bind a page flow to a custom property of type **Attribute**. |
| --- | --- |
