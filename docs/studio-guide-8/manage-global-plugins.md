...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/manage-global-plugins>
...
By default, a set of plugins gets installed on your local machine when you install the Neutrinos Studio. The default plugins include:
