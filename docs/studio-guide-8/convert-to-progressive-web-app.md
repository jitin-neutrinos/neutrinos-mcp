...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/convert-to-progressive-web-app>

| ![Information](/resources/Storage/studio-guide-8/info.png) | To convert your app to PWA, you need Neutrinos Studio 7.7.0 or later. |
| --- | --- |
...
1. Click **Settings** on the [Studio Application page](/smart/project-concepts/studio-application-page), and select **PWA**.
    ![Selecting PWA](/resources/Storage/studio-guide-8/pwa1.png)
2. Toggle **PWA** to true.
    ![Enable PWA](/resources/Storage/studio-guide-8/pwa2.png)
3. **Note that once you convert your app to a PWA, you cannot convert it back to a standard app using this editor.** Click **Okay** to confirm your action.
    ![confirmation pop-up](/resources/Storage/studio-guide-8/pwa_popup.png)
