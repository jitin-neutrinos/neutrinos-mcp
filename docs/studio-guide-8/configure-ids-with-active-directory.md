...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/configure-ids-with-active-directory>
...
![Active Directory IDS](/resources/Storage/studio-guide-8/Active%20Directoy_ids.png)
...
| ![Information](/resources/Storage/studio-guide-8/info.png) | After the duplicate flows are created, make sure you delete the customized IDS flows, else duplicated endpoints will result in unexpected behaviors.Also, make sure that you configure the [Middleware sequences](/smart/project-server-side-service-designer/ids-services) by adding the required nodes if you deleted the original nodes. |
| --- | --- |
...
- To give users access to the app, create **Teams** and onboard** U****sers **on Neutrinos Console. You should have the **organisation admins** privilege to perform this operation. See [User Management](/articles/studio-guide-8/perform-user-management).
