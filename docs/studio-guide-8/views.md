...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/views>
...
![Weathercard View](/resources/Storage/studio-guide-8/weathercard%20view2019-07-09_12h28_59.png)

![Weather card view](/resources/Storage/studio-guide-8/2019-07-09_12h32_46.png)
...
![Cyclic dependancy](/resources/Storage/studio-guide-8/Cyclic%20dependancy2019-07-09_12h35_44.png)
...
![city name declared as a page input variable](/resources/Storage/studio-guide-8/cityName_oninit.png)
...
![Bind child property and parent property](/resources/Storage/studio-guide-8/cityname_searchString.png)
...
![page output variables](/resources/Storage/studio-guide-8/page_output_var.png)
...
For example, here we have bound the output property to a page flow called **updateLog**. See [Bind Page Flows to a Component's Attribute](/articles/studio-guide-8/bind-page-flows-to-components) to learn how to use the flow picker to bind a page flow to a component's attribute.

![binding output variable to a page flow](/resources/Storage/studio-guide-8/log_output.png)
