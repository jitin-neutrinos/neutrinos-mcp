...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/translate-the-app-ui-to-multiple-languages>
...
Open the **Locales **Editor.
 ...
 ![](/resources/Storage/studio-guide-8/translate-the-app-ui-to-multiple-languages-2021-11-25-3.png)
...
**Step 2: Bind the keyword defined on the Locales editor to the Page UI**
 ...
 Note that you can copy the path of any key directly by using the ![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24.png) icon next to the respective key.
 ![toolbar properties](/resources/Storage/studio-guide-8/toolbar_content.png)
 ...
 ![switch the key to Africaans](/resources/Storage/studio-guide-8/africaans.png)![Switch to English](/resources/Storage/studio-guide-8/english.png)
 ...
 ![switch case](/resources/Storage/studio-guide-8/switch_lang.png)
 ...
 ![mapping the first condition of the switch node](/resources/Storage/studio-guide-8/switch_flow.png)
 ...
 ![Flow picker](/resources/Storage/studio-guide-8/flow_picker_lang.png)
 ...
 ![keyword in kannada](/resources/Storage/studio-guide-8/kannada.png)![keyword in Chinese](/resources/Storage/studio-guide-8/chinese.png)
...
![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24-9.png)
...
1. Open the Locales Editor. click ![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24.png) icon next to the **India** under the **Countries **to copy the path of the key.
...
![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24-11.png)
...
![](/resources/Storage/studio-guide-8/translate-the-app-ui-to-multiple-languages-2021-11-30.png)

On Deployment this is how the app will look:

![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24-6.png) ![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-24-8.png)
...
2. Drag and drop a **Variable** to the flow designer. Open the **Variable Properties** and add two variables as **eligibility** and** ageGroup. **Click** ![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-6.png) **to save**. **

![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-1.png)
...
4. Click ![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-6.png) to save.

![](/resources/Storage/studio-guide-8/translate-the-app-ui-to-multiple-languages-2021-11-25-2.png)

![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-2.png)
...
![](/resources/Storage/studio-guide-8/translate-the-app-ui-to-multiple-languages-2021-11-30-3.png)
...
![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-4.png)
...
![](/resources/Storage/studio-guide-8/apply-internationalization-2021-11-26-5.png)

8. Drag and drop a HTML 5 component to the page UI.

![](/resources/Storage/studio-guide-8/translate-the-app-ui-to-multiple-languages-2021-11-30-4.png)

9. Click **Save.**

On Deployment this is how the app will look:

| ![Information](/resources/Storage/studio-guide-8/info.png) | If you are migrating an app from lower versions to 8.X.X, refer [Locales properties](/articles/studio-guide-7/apply-internationalization) to learn how to access the locale variable in the TS (deprecated) file. |
| --- | --- |
