...
<https://documentation.neutrinos.com/articles/#!studio-guide-8/deploying-an-application-on-cloud>
...
![1-Click deploy](/resources/Storage/studio-guide-8/cloud_deploy.png)

#### Deploy the App

| ![Information](/resources/Storage/studio-guide-8/info.png) | See [IDS with Cloud Deployment](/articles/studio-guide-8/ids-with-cloud-deployment) if you have enabled IDS services for your app. |
| --- | --- |
